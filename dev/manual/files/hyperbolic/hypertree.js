...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     public_methods=
      [0,
       ...
       caml_string_of_jsbytes("reload"),
       caml_string_of_jsbytes("replace")],
     s$0=caml_string_of_jsbytes("3.7.1"),
    ...
    var
     ...
     _v_=[0,0,0,0],
     _w_=[0,caml_string_of_jsbytes("map.ml"),399,10],
     _x_=[0,0,0],
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_k$_ = caml_wrap_exception(_k$_);
              if(_k$_[1] !== Sys_error)throw _k$_;
              var _k__=_k$_}
            var param$0=l;
            continue}
          return 0}}
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i && ! (l < i))
       try
        {index_rec(s,l,i,c);var _k8_=1;return _k8_}
       catch(_k9_)
        {_k9_ = caml_wrap_exception(_k9_);
         if(_k9_ === Not_found)return 0;
         throw _k9_}
      return invalid_arg(_o_)}
    function contains(s,c){return contains_from(s,0,c)}
    function iter$0(f,a)
     {var _k6_=a.length - 1 - 1 | 0,_k5_=0;
      if(! (_k6_ < 0))
       {var i=_k5_;
        for(;;)
         {caml_call1(f,a[1 + i]);
    ...
    function map(f,a)
     {var l=a.length - 1;
      if(0 === l)return [0];
      var r=caml_make_vect(l,caml_call1(f,a[1])),_k3_=l - 1 | 0,_k2_=1;
      if(! (_k3_ < 1))
       {var i=_k2_;
        for(;;)
    ...
    function fold_left(f,x,a)
     {var r=[0,x],_k0_=a.length - 1 - 1 | 0,_kZ_=0;
      if(! (_k0_ < 0))
       {var i=_kZ_;
        for(;;)
         {r[1] = caml_call2(f,r[1],a[1 + i]);
          var _k1_=i + 1 | 0;
          if(_k0_ !== i){var i=_k1_;continue}
          break}}
      return r[1]}
    caml_fresh_oo_id(0);
    function _y_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_kY_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_kY_]}
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_kT_=height(lr);
            if(_kT_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _kU_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_kU_)}
            return invalid_arg(_q_)}
          return invalid_arg(_r_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_kV_=height(rl);
            if(_kV_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _kW_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_kW_)}
            return invalid_arg(_s_)}
          return invalid_arg(_t_)}
        var _kX_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
      ...
      function min_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _kR_=param$0[1];
            if(_kR_){var param$0=_kR_;continue}
         ...
         {var _kP_=param[1];
          if(_kP_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_kP_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_u_)}
      function _ks_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _kM_=caml_call2(p,v,d);
            if(_kM_)
             {var _kN_=for_all(p,l);
              if(_kN_){var param$0=r;continue}
              var _kO_=_kN_}
            else
             var _kO_=_kM_;
            return _kO_}
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _kJ_=caml_call2(p,v,d);
            if(_kJ_)
             var _kK_=_kJ_;
            else
             {var _kL_=exists(p,l);
              if(! _kL_){var param$0=r;continue}
              var _kK_=_kL_}
            return _kK_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _kF_=merge(f,r1,r2),
             _kG_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_kG_,_kF_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _kH_=merge(f,r1$0,r2$0),
           _kI_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_kI_,_kH_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _kD_=concat(lf,rf);return [0,join(lt,v,d,rt),_kD_]}
          var _kE_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_kE_]}
        return _x_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _kA_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_kA_)
               {var _kB_=caml_call2(cmp,d1,d2);
                if(_kB_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_kz_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _kz_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_kx_=cons_enum(t,rest);
          return [0,[0,k,v],function(_ky_){return seq_of_enum(_kx_,_ky_)}]}
        return 0}
      function to_seq(m)
       {var _kv_=cons_enum(m,0);
        return function(_kw_){return seq_of_enum(_kv_,_kw_)}}
    ...
    function add(x,q)
     {var cell=[0,x,0],_kr_=q[3];
      return _kr_
              ?(q[1] = q[1] + 1 | 0,_kr_[2] = cell,q[3] = cell,0)
    ...
    function trans(ty1,match)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_j8_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_j8_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_j9_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_j9_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_j__=ty1[1];
          if(typeof match === "number")
           switch$3 = 1;
          else
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_j__,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_j$_=ty1[1];
          if(typeof match === "number")
           switch$4 = 1;
          else
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_j$_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_ka_=ty1[1];
          if(typeof match === "number")
           switch$5 = 1;
          else
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_ka_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_kb_=ty1[1];
          if(typeof match === "number")
           switch$6 = 1;
          else
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_kb_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_kc_=ty1[1];
          if(typeof match === "number")
           switch$7 = 1;
          else
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_kc_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_kd_=ty1[1];
          if(typeof match === "number")
           switch$8 = 1;
          else
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_kd_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_ke_=ty1[2],_kf_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_kg_=trans(_ke_,rest2$7);
              return [8,trans(_kf_,ty2),_kg_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_kh_=ty1[3],_ki_=ty1[2],_kj_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_ki_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_kj_,ty22,trans(_kh_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_kk_,rest2$9)]}
          throw [0,Assert_failure,_al_];
         case 11:
          var switch$11=0,_kl_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_kl_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_am_];
          break;
         case 12:
          var switch$12=0,_km_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_km_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_an_];
          break;
         case 13:
          var switch$13=0,_kn_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_kn_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ao_];
          break;
         default:
          var switch$14=0,_ko_=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_ko_,rest2$13)];
             default:switch$14 = 1}
        ...
        {case 0:
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _j0_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _j1_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _j2_=function(param){caml_call1(de$12,0);return 0},
           _j3_=function(param){caml_call1(ed$12,0);return 0},
           _j4_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _j5_=function(param){caml_call1(de$13,0);return 0},
           _j6_=function(param){caml_call1(ed$13,0);return 0},
           _j7_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       {if(prec)
         {var _jJ_=match[2];
          if(typeof _jJ_ !== "number" && 2 === _jJ_[0])
           {var rest=_jJ_[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _jH_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_jH_))
             throw Type_mismatch;
            var _jI_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_jI_))
             throw Type_mismatch;
            var
        ...
        {case 0:
         ...
         case 3:
          var
           ...
           _js_=match$3[2],
           _jr_=match$3[1];
          if(typeof _js_ !== "number" && 1 === _js_[0])
           {var
             fmtty_rest$2=_js_[1],
             match$4=type_format_gen(fmt_rest$2,fmtty_rest$2),
             fmtty$3=match$4[2],
             fmt$3=match$4[1];
            return [0,[3,_jr_,fmt$3],fmtty$3]}
          throw Type_mismatch;
         case 4:
          var
           fmt_rest$3=fmt[4],
          ...
          if(typeof _ju_ !== "number" && 2 === _ju_[0])
           {var
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_jt_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           _jw_=match$7[3],
           _jv_=match$7[1];
          if(typeof _jw_ !== "number" && 3 === _jw_[0])
           {var
             fmtty_rest$4=_jw_[1],
             prec$2=match$7[2],
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_jv_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           _jy_=match$9[3],
           _jx_=match$9[1];
          if(typeof _jy_ !== "number" && 4 === _jy_[0])
           {var
             fmtty_rest$5=_jy_[1],
             prec$4=match$9[2],
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_jx_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           _jA_=match$11[3],
           _jz_=match$11[1];
          if(typeof _jA_ !== "number" && 5 === _jA_[0])
           {var
             fmtty_rest$6=_jA_[1],
             prec$6=match$11[2],
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_jz_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           _jC_=match$13[3],
           _jB_=match$13[1];
          if(typeof _jC_ !== "number" && 6 === _jC_[0])
           {var
             fmtty_rest$7=_jC_[1],
             prec$8=match$13[2],
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_jB_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           ...
           _jE_=match$15[2],
           _jD_=match$15[1];
          if(typeof _jE_ !== "number" && 7 === _jE_[0])
           {var
             fmtty_rest$8=_jE_[1],
             match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$16[2],
             fmt$9=match$16[1];
            return [0,[9,_jD_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _jF_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_jF_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _jG_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_jG_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_jG_[1];
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _jo_=2 === padty$0?48:32,res=make(width$0,_jo_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _jm_ >>> 0)
           {if(33 < (_jm_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _jm_)switch$0 = 1;
           ...
           {var i$0=_je_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _jj_=match - 34 | 0,switch$2=0;
                if(58 < _jj_ >>> 0)
                 {if(93 <= _jj_)switch$2 = 1}
                else
                 if(56 < (_jj_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
                if(! switch$2){var _jk_=1;switch$1 = 2}}
              else
               if(11 <= match)
              ...
              switch(switch$1)
               {case 0:var _jk_=4;break;case 1:var _jk_=2;break}
              n[1] = n[1] + _jk_ | 0;
              var _jl_=i$0 + 1 | 0;
             ...
             {var i=_jg_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i),switch$3=0;
                ...
                break}}
            var _jn_=s}
          var str$0=caml_string_of_bytes(_jn_)}
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _i9_=_as_;break;
        case 2:var _i9_=_at_;break;
        case 4:var _i9_=_av_;break;
        case 5:var _i9_=_aw_;break;
        case 6:var _i9_=_ax_;break;
        case 7:var _i9_=_ay_;break;
        case 8:var _i9_=_az_;break;
        case 9:var _i9_=_aA_;break;
        case 10:var _i9_=_aB_;break;
        case 11:var _i9_=_aC_;break;
        case 0:
        case 13:var _i9_=_ar_;break;
        case 3:
        case 14:var _i9_=_au_;break;
        default:var _i9_=_aD_}
    ...
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _i8_=_aS_;break;
        ...
        case 9:var _i8_=_a0_;break;
        case 10:var _i8_=_a1_;break;
        case 11:var _i8_=_a2_;break;
        case 0:
        case 13:var _i8_=_aR_;break;
        case 3:
        case 14:var _i8_=_aU_;break;
        default:var _i8_=_a3_}
      return transform_int_alt(iconv,caml_format_int(_i8_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _i7_=_a5_;break;
        case 2:var _i7_=_a6_;break;
        case 4:var _i7_=_a8_;break;
        case 5:var _i7_=_a9_;break;
        case 6:var _i7_=_a__;break;
        case 7:var _i7_=_a$_;break;
        case 8:var _i7_=_ba_;break;
        case 9:var _i7_=_bb_;break;
        case 10:var _i7_=_bc_;break;
        case 11:var _i7_=_bd_;break;
        case 0:
        case 13:var _i7_=_a4_;break;
        case 3:
        case 14:var _i7_=_a7_;break;
        default:var _i7_=_be_}
      return transform_int_alt(iconv,caml_format_int(_i7_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _i6_=_aF_;break;
        case 2:var _i6_=_aG_;break;
        case 4:var _i6_=_aI_;break;
        case 5:var _i6_=_aJ_;break;
        case 6:var _i6_=_aK_;break;
        case 7:var _i6_=_aL_;break;
        case 8:var _i6_=_aM_;break;
        case 9:var _i6_=_aN_;break;
        case 10:var _i6_=_aO_;break;
        case 11:var _i6_=_aP_;break;
        case 0:
        case 13:var _i6_=_aE_;break;
        case 3:
        case 14:var _i6_=_aH_;break;
        default:var _i6_=_aQ_}
          ...
          {if(i$0 === len)
            ...
            {var
             ...
             if(23 < _i3_ >>> 0)
              ...
              if(21 < (_i3_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _i4_=1}
           var _i5_=_i4_?str:symbol(str,_bf_);
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _iU_=pad$5[2],_iV_=pad$5[1];
               if(typeof prec$3 === "number")
                return prec$3
                        ?function(p,x)
                          {var str=fix_padding(_iV_,_iU_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)}
                        :function(x)
                          {var
                            str=convert_float(fconv,default_float_precision(fconv),x),
                            str$0=fix_padding(_iV_,_iU_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_iV_,_iU_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _iW_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(w,p,x)
                        {var str=fix_padding(_iW_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_iW_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_iW_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _iX_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _iX_[2] === "number")
              {var fmt=_iX_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_iT_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_iT_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _iQ_=[8,acc,_bp_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_iQ_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_iQ_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_iP_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_iP_,rest])}
           ...
           return match
                   ?function(p,x)
                     {var
                       str=
                        fix_padding
                         (_iN_,_iM_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(x)
                     {var str=fix_padding(_iN_,_iM_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_iN_,_iM_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _iO_=pad[1];
        if(typeof match === "number")
         return match
                 ?function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_iO_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,x)
                   {var str=fix_padding(_iO_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_iO_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_iH_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_iH_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bx_;
      var _iF_=other_fields(x,i + 1 | 0),_iG_=field(x,i);
      return caml_call2(sprintf(_by_),_iG_,_iF_)}
     ...
     {function conv(param)
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _iA_=other_fields(e,2),
          _iB_=field(e,1),
          _iD_=caml_call2(sprintf(_bz_),_iB_,_iA_);
        else
         switch(match)
          {case 0:var _iD_=_bA_;break;
           case 1:var _iD_=_bB_;break;
           default:var _iC_=field(e,1),_iD_=caml_call1(sprintf(_bC_),_iC_)}
        return symbol(constructor,_iD_)}
      return e[1]}
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _iy_=a.length - 1 - 1 | 0,_ix_=0;
        if(! (_iy_ < 0))
         {var i=_ix_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              match=
               [0,
                caml_call7(sprintf(_bN_),_iv_,_iu_,_it_,_is_,_ir_,_iq_,_ip_)];
            else
             if(slot[1])
              var match=0;
             else
              var _iw_=info(0),match=[0,caml_call1(sprintf(_bP_),_iw_)];
            if(match){var str=match[1];caml_call1(fprintf(outchan,_bQ_),str)}
            var _iz_=i + 1 | 0;
            if(_iy_ !== i){var i=_iz_;continue}
            break}}
        return 0}
    ...
    function get_method_label(table,name)
     {try
       {var _hT_=caml_call2(Meths[28],name,table[3]);return _hT_}
      catch(_hU_)
    ...
    function new_cache(table)
     {var n=new_method(table),switch$0=0;
      ...
      return n$0}
    var t2=joo_global_object,t10=null,undefined$0=undefined;
    function test(x){return 1 - (x == t10?1:0)}
    function iter$1(x,f)
     {var _hQ_=1 - (x == t10?1:0);return _hQ_?caml_call1(f,x):_hQ_}
     ...
     {for(;;)
       {if(0 === type && 0 === name)return createElement(doc,elt);
        ...
        if(785140586 === _hG_)
         {try
           {var
             el=t715.createElement('<input name="x">'),
    ...
    function stopPropagation(ev)
     {function _hE_(param){return ev.stopPropagation()}
      function _hF_(param){return ev.cancelBubble = t67}
         ...
         {var
          ...
          try
           ...
           {_hD_ = caml_wrap_exception(_hD_);
            if(_hD_ === Not_found)
             {var
               now=function(param){var t120=new t119();return t120.getTime()},
               last=[0,now(0)];
    ...
    function regexp(s)
     {var t0=caml_jsbytes_of_string(s);return new t2$0(t0,"g")}
    new t2$0("[$]","g");
    var t48=regexp(_b9_);
    ...
    new t2$0(caml_jsbytes_of_string(_cd_));
    new t2$0(caml_jsbytes_of_string(_ce_));
            ...
            {if(i$0[1] < len)
              {var
               ...
               if(typeof clo === "number")
                ...
                var clo$0=clo;
               method_count[1]++;
               if(caml_call2(Labs[28],label,_gV_[4]))
    ...
    var t767=caml_js_get_console(0);
    caml_fresh_oo_id(0);
     ...
     {var match=task(0),w=match[2],t=match[1],d=0.;
      ...
      function loop(step,param)
       {if(2147483000. < step)
        ...
        var
         cb=remain == 0.?callback:function(_gq_){return loop(remain,_gq_)},
      ...
      on_cancel
       (t,
        function(param)
         {var _gp_=id[1];
          if(_gp_){var x=_gp_[1];id[1] = 0;return t2.clearTimeout(x)}
          return 0});
      return t}
    ...
    function prerr_string$0(s)
     {var t3=caml_jsstring_of_string(s);return t767.log(t3)}
     ...
     {var opt=[0,0];
      ...
      iter
       (function(param)
         {var
          ...
          return t11.setRequestHeader(t43,t44)},
        headers);
      function headers$0(s)
       {function _gi_(v){return [0,caml_string_of_jsstring(v)]}
        ...
        return case$0(t11.getResponseHeader(t41),_gj_,_gi_)}
      var st=[0,382334108];
              ...
              {var
                ...
                _gd_=
                 function(param)
                  {var x=t11.responseXML;
                   ...
                   return 0},
                _ge_=function(x){return caml_string_of_jsstring(x)},
                ...
                response=
                 [0,
                  ...
                  code,
                  headers$0,
                  case$0(t11.responseText,_gf_,_ge_),
                  _gd_];
    ...
    function load_image(src)
     {var img=createImg(t715);
      function _f9_(param){return return$0(img)}
      var match=task(0),w=match[2],t=match[1];
      img.onload = handler(function(param){wakeup(w,0);return t212});
      img.src = src;
      return symbol_bind(t,_f9_)}
    function create_canvas(w,h)
     {var d=t2.document,c=createCanvas(d);c.width = w;c.height = h;return c}
    var debug_widget=createDiv(t715);
    ...
    var
     text_size_div=
      [246,
       function(_f8_)
        {var d=createDiv(t715);
         d.style.visibility = "hidden";
         d.style.position = "absolute";
         d.style.whiteSpace = "nowrap";
         appendChild(t715.body,d);
         return d}];
    function f(param)
     {function _f6_(param)
       {function _f7_(param){return "en"}
        return get(t2.navigator.userLanguage,_f7_)}
      var t129=get(t2.navigator.language,_f6_);
      return t129.substring(0,2)}
    function _cz_(st){var x=st.getItem("hyp_lang");return x == t10?f(0):x}
    var language=[0,case$1(t2.localStorage,f,_cz_)];
    t767.log(language[1]);
    ...
    function ellipse_arc(t145,cx,cy,rx,ry,start,fin,clock_wise)
     {t145.save();
      t145.translate(cx,cy);
      t145.scale(rx,ry);
      t145.arc(0.,0.,1.,start,fin,clock_wise);
      return t145.restore()}
    ...
    function compute_text_node(info)
     {var
      ...
      d.style.font = font;
      var t118=caml_jsstring_of_string(info),txt=t715.createTextNode(t118);
      appendChild(d,txt);
      ...
      var
       w$0=w + 8 | 0,
       h$0=h + 8 | 0,
       t271=create_canvas(w$0,h$0),
       t256=t271.getContext("2d");
      t256.fillStyle = opt_style(style.nodeBackgroundColor,tree_color);
      var t82=min(4.,min(w$0,h$0) / 2.);
      t256.beginPath();
      var t102=0. + t82;
      t256.moveTo(t102,0.);
      var t99=0. + t82,t98=0. + w$0,t96=0. + w$0;
      t256.arcTo(t96,0.,t98,t99,t82);
      var t93=0. + h$0,t92=0. + w$0 - t82,t91=0. + h$0,t90=0. + w$0;
      t256.arcTo(t90,t91,t92,t93,t82);
      var t87=0. + h$0 - t82,t85=0. + h$0;
      t256.arcTo(0.,t85,0.,t87,t82);
      var t80=0. + t82;
      t256.arcTo(0.,0.,t80,0.,t82);
      t256.fill();
      t256.font = font;
      t256.fillStyle = opt_style(style.nodeColor,"black");
      t256.textAlign = "center";
      t256.textBaseline = "middle";
      var t255=h$0 / 2.,t254=w$0 / 2.,t253=caml_jsstring_of_string(info);
      t256.fillText(t253,t254,t255);
      return t271}
     ...
     {try
      ...
      try
       ...
       {_fT_ = caml_wrap_exception(_fT_);
        ...
        var _fI_=_cG_}
      t715.title = caml_jsstring_of_string(_fI_);
    ...
    function close_button(over)
     {var
       ...
       t315=create_canvas(32,32),
       t290=t315.getContext("2d");
      t290.save();
      t290.lineWidth = 2.;
      t290.strokeStyle = color;
      if(over){t290.shadowBlur = 4.;t290.shadowColor = color}
      t290.beginPath();
      t290.moveTo(6.82842712474619,6.82842712474619);
      t290.lineTo(25.1715728752538084,25.1715728752538084);
      t290.moveTo(6.82842712474619,25.1715728752538084);
      t290.lineTo(25.1715728752538084,6.82842712474619);
      t290.stroke();
      t290.restore();
      var _eT_=over?_cM_:_cN_;
      t315.className = caml_jsstring_of_string(_eT_);
      t315.style.position = "absolute";
      t315.style.top = "0";
      t315.style.right = "0";
      return t315}
                ...
                {var
                 ...
                 if(0 <= i[1])
                  {var
                   ...
                   var img_container=createDiv(t715);
                   ...
                   if(match)
                    {var
                      ...
                      t534=create_canvas(info[4],info[5]),
                      t532=t534.getContext("2d");
                     t532.drawImage(small_image$0,0.,0.,info[4],info[5]);
                     t534.style.display = "block";
                     t534.style.height = "auto";
                     t534.style.width = "auto";
                     t534.style.maxWidth = "100%";
                     t534.style.maxHeight = "100%";
                     t534.style.marginLeft = "auto";
                     t534.style.marginRight = "auto";
                     var w=wrap(t534);
                     appendChild(img_container,w);
                     img.onload
                     =
                     handler
                      (function(param){removeChild(img_container,w);return t212})}
                   var _eF_=info[7];
                   if(_eF_)
                   ...
                   var
                    w$0=wrap(img),
                    handle_error=
                     function(param){removeChild(img_container,w$0);return t212};
                   ...
                   var legend=createDiv(t715);
                   legend.innerHTML = info[3];
                   legend.onclick
                   =
                   handler(function(ev){stopPropagation(ev);return t67});
                   ...
                   var
                    ...
                    list=
                     function(title,lang)
                      {var ul=createUl(t715),empty=[0,1],_eI_=info[6];
                       iter$0
                        (function(param)
                          {var
                            refer=param[3],
                           ...
                           if(_eK_)
                            {empty[1] = 0;
                             var a=createA(t715);
                             appendChild(a,t715.createTextNode(name));
                             a.target = "_blank";
                             var
                       ...
                       if(_eJ_)
                        {count[1]++;
                         var dd=createDd(t715);
                         appendChild(dd,t715.createTextNode(title));
                         appendChild(dl,dd);
                         var dt=createDt(t715);
                         appendChild(dt,ul);
                   ...
                   if(0 < count[1])
                    ...
                    {var t387=opt_style(messages.noRef,"No reference found.");
                     appendChild(txt,t715.createTextNode(t387))}
                   txt.className = "text on";
                   ...
                   appendChild(t715.body,background);
                   background.onclick
                   =
                   handler
                    (function(param)
                      {removeChild(t715.body,background);return t67})}
                 return return$0(0)})}
      ...
      addEventListener
       (t715,
        ...
        handler
         (function(e)
           {var match=e.keyCode;
            if(13 !== match && 27 !== match)return t67;
            close_info(0);
            return t212}),
        t67);
      var button=createButton(0,0,t715);
      appendChild(button,t715.createTextNode(opt_style(messages.ok,"OK")));
      button.onclick = handler(function(param){close_info(0);return t212});
      var button_div=createDiv(t715);
      button_div.style.textAlign = "center";
      button_div.style.margin = "2em auto";
      appendChild(button_div,button);
      appendChild(txt,button_div);
      return appendChild(t715.body,overlay)}
            ...
            return symbol_bind
                    (all_messages,
                     function(all_messages)
                      {var page=t715.documentElement;
                       page.style.overflow = "hidden";
                       page.style.height = "100%";
                       t715.body.style.overflow = "hidden";
                       t715.body.style.margin = "0px";
                       t715.body.style.height = "100%";
                       var
                        w=page.clientWidth,
                        h=page.clientHeight,
                        canvas=create_canvas(w,h);
                       appendChild(t715.body,canvas);
                       var
                        tr=[0,[0,zero,t]],
                        tr$0=[0,tr[1]],
                        l=vertices.length - 1,
                          ...
                          {var i=_d3_;
                           for(;;)
                            {var
                             ...
                             break}}
                         t767.timeEnd("transform");
                         t767.time("draw");
                         var
                          t188=canvas.getContext("2d"),
                          ...
                          t246=canvas.height,
                          t245=canvas.width;
                         t188.clearRect(0.,0.,t245,t246);
                         var padding=opt_style(style.padding,0.);
                         t188.beginPath();
                         ellipse_arc
                          (t188,dx$1,dy$1,rx$1 + padding,ry$1 + padding,0.,7.,t212);
                         function _d7_(color)
                          {t188.fillStyle = color;return t188.fill()}
                         iter$2(style.backgroundColor,_d7_);
                         function _d8_(color)
                          {t188.lineWidth = 1.;
                           t188.strokeStyle = color;
                           return t188.stroke()}
                         iter$2(style.boundaryColor,_d8_);
                         t188.lineWidth = 2.;
                         t188.lineCap = "round";
                         t188.strokeStyle = opt_style(style.treeColor,tree_color);
                         var
                          ry$2=transf$0[2],
                          rx$2=transf$0[1],
                              ...
                              {t188.lineWidth = w$3;
                               ...
                               if(Math.abs(d) < 0.05)
                                {var
                                  ...
                                  rx$0=transf$0[1];
                                 t188.beginPath();
                                 var t174=z1[2] * ry$0 + dy$0,t173=z1[1] * rx$0 + dx$0;
                                 t188.moveTo(t173,t174);
                                 var t171=z2[2] * ry$0 + dy$0,t170=z2[1] * rx$0 + dx$0;
                                 t188.lineTo(t170,t171);
                                 t188.stroke()}
                               else
                                {var
                                  n1=sq_norm(z1) + 1.,
                                 ...
                                 if(rx == ry)
                                  {var
                                    ...
                                    t162=z0[2] * rx + dy,
                                    t161=z0[1] * rx + dx;
                                   t188.arc(t161,t162,t163,t164,t165,t166)}
                                 else
                                  ellipse_arc
                                   (t188,
                                    z0[1] * rx + dx,
                          ...
                          {var i$0=_d$_;
                           for(;;)
                            {var
                                  ...
                                  {var
                                   ...
                                   if(circle)
                                    {t188.beginPath();
                                     ...
                                     var
                                      t209=Math.sqrt(w$0 * w$0 + h$0 * h$0),
                                      t208=z[2] * ry$2 + dy$1,
                                      t207=z[1] * rx$2 + dx$1;
                                     t188.arc(t207,t208,t209,0.,7.,t212);
                                     t188.fill()}
                                   var
                                    t204=2. * h$0,
                                    t203=2. * w$0,
                                    t202=z[2] * ry$2 + dy$1 - h$0,
                                    t201=z[1] * rx$2 + dx$1 - w$0;
                                   t188.drawImage(txt,t201,t202,t203,t204)}
                                 else
                                  switch$1 = 1}
                               else
                                    ...
                                    {var
                                     ...
                                     if(_ei_)
                                      {var
                                        ...
                                        t185=y$0 - h$2,
                                        t184=x$0 - w$2;
                                       t188.drawImage(img$1,t184,t185,t186,t187);
                             ...
                             break}}
                         t767.timeEnd("draw");
                         return t767.log(image_count[1],large_image_count[1])};
                       perform_redraw(0);
                       t2.onresize
                       =
                       handler
                       ...
                       handler
                        (function(ev)
                          {update_cursor(ev.clientX,ev.clientY);return t212});
                       canvas.onmousedown
                       =
                       handler
                        (function(ev)
                                             ...
                                             function(touch)
                                              {var _dH_=touch.identifier === id?1:0;
                                               if(_dH_)
                                                ...
                                                var _dM_=_dH_;
                                               return _dM_},
                                            t66=ev.changedTouches;
                                           iter$2(t66.item(i),_dF_);
                                           var _dG_=i + 1 | 0;
                                            ...
                                            {var _dz_=touch.identifier === id?1:0;
                                             if(_dz_)
                                              {var x=touch.clientX,y=touch.clientY;
                                               ...
                                               return _dC_}
                                             return _dz_},
                                          t55=ev.changedTouches;
                                         iter$2(t55.item(i),_dx_);
                                         var _dy_=i + 1 | 0;
                                            ...
                                            {var _du_=touch.identifier === id?1:0;
                                             if(_du_)
                                              {removeEventListener(c1);
                                               ...
                                               return 0}
                                             return _du_},
                                          t44=ev.changedTouches;
                                         iter$2(t44.item(i),_ds_);
                                         var _dt_=i + 1 | 0;
                         ...
                         switch(switcher)
                          {case 0:
                           ...
                           default:
                            ...
                            schedule_redraw(0);
                            return t212}}
                       addEventListener(t715,keydown,handler(handle_key_event),t67);
                       var prev_buttons=[0,0];
                       function make_buttons(param)
                        {var _dn_=prev_buttons[1];
                         if(_dn_){var buttons=_dn_[1];removeChild(t715.body,buttons)}
                         var buttons$0=createDiv(t715);
                         ...
                         handler
                          (function(param)
                            {show_information_page(messages,tree_i18n);return t212});
                         ...
                         var txt=createDiv(t715),dl=createDl(t715),ul=createUl(t715);
                         iter
                          (function(param)
                            {var
                              id=param[2],
                              name=param[1],
                              a=createA(t715),
                              t720=caml_jsstring_of_string(name);
                             appendChild(a,t715.createTextNode(t720));
                             a.href = "#";
                             a.onclick
                             =
                             handler
                              (function(param)
                                {var lang=caml_jsstring_of_string(id);
                                 function _do_(t138){return t138.setItem("hyp_lang",lang)}
                                 iter$2(t2.localStorage,_do_);
                                 language[1] = lang;
                                 make_buttons(0);
                         ...
                         var
                          dd=createDd(t715),
                          t714=opt_style(messages.languages,"Languages");
                         appendChild(dd,t715.createTextNode(t714));
                         appendChild(dl,dd);
                         var dt=createDt(t715);
                         appendChild(dt,ul);
                         appendChild(dl,dt);
                         ...
                         appendChild(t715.body,buttons$0);
                       ...
                       appendChild(a,img);
                       var logo=createDiv(t715);
                       logo.style.position = "absolute";
                       logo.style.left = "0";
                       logo.style.bottom = "0";
                       appendChild(logo,a);
                       appendChild(t715.body,logo);
                       return return$0(0)})}),
       _dm_=underlying(p)[1];
      switch(_dm_[0])
    ...
    function start(param)
     {try
       {createCanvas(t2.document);var _dk_=_c6_(0);return _dk_}
      catch(_dl_)
       {_dl_ = caml_wrap_exception(_dl_);
        if(_dl_ === Canvas_not_available){unsupported_messages(0);return t212}
        throw _dl_}}
