...
(function(joo_global_object)
   {"use strict";
     ...
     {for(;;)
       {if(0 === type && 0 === name)return createElement(doc,elt);
        ...
        if(785140586 === _dY_)
         {try
           {var
             el=t2$0.createElement('<input name="x">'),
              ...
              map
               (function(param)
                 {var
                  ...
                  return symbol$0(t2$0.createElement(t50),c)},
                entries);
            return symbol$0(t2$0.createElement("tr"),_cR_)},
          rows),
       _cQ_=[0,symbol$0(t2$0.createElement("tbody"),rows$0),0];
      return symbol$0(t2$0.createElement("table"),_cQ_)}
    function _cc_(param){return t2$0.createElement("hr")}
    function _cd_(s){return list_builder(t2$0,_ce_,s)}
    function _cf_(s){return list_builder(t2$0,_cg_,s)}
    function _ch_(s){return symbol$0(t2$0.createElement("h6"),s)}
    function _ci_(s){return symbol$0(t2$0.createElement("h5"),s)}
    function _cj_(s){return symbol$0(t2$0.createElement("h4"),s)}
    function _ck_(s){return symbol$0(t2$0.createElement("h3"),s)}
    function _cl_(s){return symbol$0(t2$0.createElement("h2"),s)}
    function _cm_(s){return symbol$0(t2$0.createElement("h1"),s)}
    function _cn_(s)
     {var p=t2$0.createElement("pre");
      if(s)
       ...
       var _cP_=_o_;
      var t32=caml_jsstring_of_string(_cP_);
      appendChild(p,t2$0.createTextNode(t32));
      return p}
    function _co_(s){return symbol$0(t2$0.createElement("p"),s)}
    function _cp_(addr,s)
     {var i=unsafeCreateElement(t2$0,_bN_);
      i.width = "480";
      i.height = "360";
      var
    ...
    function _cr_(addr,s)
     {var a=unsafeCreateElement(t2$0,_bL_);
      a.href = caml_jsstring_of_string(addr);
      return symbol$0(a,s)}
    function _cs_(s){return symbol$0(t2$0.createElement("tt"),s)}
    function _ct_(addr,alt)
     {var i=unsafeCreateElement(t2$0,_bM_);
      i.src = caml_jsstring_of_string(addr);
      i.alt = caml_jsstring_of_string(alt);
      return i}
    function _cu_(param){return t2$0.createElement("br")}
    function _cv_(s){return symbol$0(t2$0.createElement("em"),s)}
    function _cw_(s){return symbol$0(t2$0.createElement("strong"),s)}
    var
     b=
      [0,
       function(s)
        {var t4=caml_jsstring_of_string(s);return t2$0.createTextNode(t4)},
       _cw_,
       _cv_,
       _cu_,
       _ct_,
    ...
    function f$0(param)
     {var body=t2$0.getElementById("wiki_demo");
      ...
      var preview=createDiv(t2$0);
      preview.style.border = "1px black dashed";
      preview.style.padding = "5px";
      appendChild(body,textbox);
      appendChild(body,unsafeCreateElement(t2$0,_bK_));
