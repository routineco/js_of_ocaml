...
(function(joo_global_object)
   {"use strict";
    ...
    var x=t48.location;
    if(x !== t39)
     var _bY_=t48.location;
    else
     var
      t42=function(param,_fr_){return 0},
      t41=function(param,_fq_){return 0},
            ...
            function(s)
             {function _fk_(param)
              ...
              if(t5 < 0)
               ...
               var t7=t5 + 1 | 0,_fi_=s.slice(t7),_fj_=[0,s.slice(0,t5),_fi_];
     ...
     {var match=task(0),w=match[2],t=match[1],d$0=d * 1000.;
      ...
      on_cancel
       (t,
        function(param)
         {var _eN_=id[1];
          if(_eN_){var x=_eN_[1];id[1] = 0;return t48.clearTimeout(x)}
          return 0});
      return t}
    function f(param)
     {if(1 === param)
     ...
     {var opt=[0,0];
      ...
      function headers$0(s)
       {function _dd_(v){return [0,caml_string_of_jsstring(v)]}
        ...
        return case$0(t59.getResponseHeader(t35),_de_,_dd_)}
      var st=[0,382334108];
              ...
              {var
                ...
                response=
                 [0,
                  ...
                  code,
                  headers$0,
                  case$0(t59.responseText,_da_,_c$_),
                  _c__];
    ...
    handler
     (function(param)
       {var body=t64.getElementById("boulderdash");
        if(body == t58)throw [0,Assert_failure,_cr_];
        var
        ...
        function _cD_(levels)
         {body.style.cssText
          ...
          var h1=unsafeCreateElement(t64,_bN_);
          append_text(h1,_cv_);
          appendChild(body,h1);
          var div=createDiv(t64);
          ...
          var
           select=unsafeCreateElementEx(0,0,t64,_bL_),
                 ...
                 (_cL_,
                  function(data)
                   {var
                    ...
                    function _cV_(c)
                     {var img=unsafeCreateElement(t64,_bP_);
                      img.src = img_assoc(c);
                      return img}
                    var
                     ...
                     style$0=[0,style],
                     table=unsafeCreateElement(t64,_bQ_);
