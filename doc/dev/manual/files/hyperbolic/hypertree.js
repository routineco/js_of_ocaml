...
(function(globalThis)
   {"use strict";
    ...
    var
     ...
     _e_=caml_string_of_jsbytes("CamlinternalLazy.Undefined"),
     ...
     _p_=caml_string_of_jsbytes("String.contains_from / Bytes.contains_from"),
     _o_=caml_string_of_jsbytes("String.index_from / Bytes.index_from"),
    ...
    var
     ...
     Undefined=[248,_e_,caml_fresh_oo_id(0)];
    ...
    var compare$2=caml_compare,Storage_map=_z_([0,compare$2]);
     ...
     {var match=task(0),w=match[2],t=match[1],d=0.;
      ...
      function loop(step,param)
       {if(2147483000. < step)
        ...
        id[1] = [0,t703.setTimeout(t125,step$0)];
        return 0}
      loop(d,0);
      on_cancel
       (t,
