   ...
   {"use strict";
      ...
      function add_str(opt,s)
       {if(opt)var sth=opt[1],surr=sth;else var surr=_b0_;
        return is_visible_text(s)
                ...
                :0}
      var t3=body.childNodes,_dk_=t3.length - 1 | 0,_dj_=0;
      if(! (_dk_ < 0))
       {var i=_dj_;
        for(;;)
         {var
              ...
              if(0 <= switch$0)
               ...
               {if(! caml_string_notequal(hh,_cb_))
                ...
                if(! caml_string_notequal(hh,_cc_))
                 {var
                   t7=get(node,function(param){throw [0,Assert_failure,_ci_]}),
                   _do_=
                    function(s)
                     {var _dq_=caml_string_of_jsstring;
                      function _dr_(param){throw [0,Assert_failure,_cj_]}
                      var
                       url=symbol$0(get(t7.getAttribute("href"),_dr_),_dq_),
                  ...
                  return case$0(t7.getAttribute("wysitype"),_dp_,_do_)}
    ...
    function onload(param)
     {function _c9_(param){throw [0,Assert_failure,_cv_]}
      var
       body=get(t11.getElementById("wiki_demo"),_c9_),
       iframe=unsafeCreateElement(t11,_bL_);
       ...
       {iDoc.open();
        ...
        function createButton(opt,_dh_,title,action)
         {if(opt)var sth=opt[1],show=sth;else var show=t50;
          ...
          var type=[0,"submit"],but=unsafeCreateElementEx(type,0,t11,_bI_);
          ...
          handler
           (function(param)
             {t48.focus();
              ...
              iDoc.execCommand(t30,show,_di_);
              return true$0});
        ...
        function prompt(query,default$0)
         {var _df_=caml_string_of_jsstring;
          ...
          return symbol$0(get(t48.prompt(t36,t37),_dg_),_df_)}
        var
         _c$_=
          handler
           (function(param)
