...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _bN_=caml_string_of_jsbytes("iframe"),
     _bM_=caml_string_of_jsbytes("img"),
     _bL_=caml_string_of_jsbytes("a"),
     _bK_=caml_string_of_jsbytes("br"),
     _bJ_=caml_string_of_jsbytes("div"),
     _bI_=caml_string_of_jsbytes("textarea"),
     _bX_=[0,0],
     _bY_=[0,1],
     _bV_=[0,0],
     _bW_=[0,1],
     ...
     _bR_=
      [0,
       ...
       caml_string_of_jsbytes("Lwt.%s")],
     _bS_=[0,0],
     _bO_=caml_string_of_jsbytes("Fatal error: exception "),
     _bP_=caml_string_of_jsbytes("Lwt.Resolution_loop.Canceled"),
     _b0_=caml_string_of_jsbytes("Exception during Lwt.async: "),
     _b4_=[0,caml_string_of_jsbytes("examples/wiki/wikicreole.mll"),207,32],
     _b5_=[0,caml_string_of_jsbytes("examples/wiki/wikicreole.mll"),216,6],
     _b6_=[0,caml_string_of_jsbytes("examples/wiki/wikicreole.mll"),231,6],
     _b8_=[0,caml_string_of_jsbytes("examples/wiki/wikicreole.mll"),285,6],
     _b9_=caml_string_of_jsbytes("*"),
     _b7_=[5,0],
     _b3_=[0,caml_string_of_jsbytes("examples/wiki/wikicreole.mll"),158,6],
     _b1_=caml_string_of_jsbytes("//"),
     _b2_=caml_string_of_jsbytes("**"),
     _cq_=caml_string_of_jsbytes("http://youtube.com/embed/"),
     _cg_=caml_string_of_jsbytes("ul"),
     _ce_=caml_string_of_jsbytes("ol"),
     _ca_=caml_string_of_jsbytes("th"),
     _cb_=caml_string_of_jsbytes("td"),
     _cx_=[0,caml_string_of_jsbytes("examples/wiki/main.ml"),33,70],
    ...
    function engine(tbl,state,buf)
     {var
       ...
       _f7_=0 <= result?1:0,
       _f8_=_f7_?buf[12] !== dummy_pos?1:0:_f7_;
      if(_f8_)
       {buf[11] = buf[12];
        var _f9_=buf[12];
        buf[12] = [0,_f9_[1],_f9_[2],_f9_[3],buf[4] + buf[6] | 0]}
      return result}
    ...
    function add(x,q)
     {var cell=[0,x,0],_f6_=q[3];
      return _f6_
              ?(q[1] = q[1] + 1 | 0,_f6_[2] = cell,q[3] = cell,0)
       ...
       switch(formatting_lit[0])
        {case 0:var str=formatting_lit[1];return str;
         ...
         default:
          ...
          return symbol(_z_,caml_string_of_bytes(make(1,c)))}}
    ...
    function trans(ty1,match)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_fL_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_fL_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_fM_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_fM_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_fN_=ty1[1];
          if(typeof match === "number")
           switch$3 = 1;
          else
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_fN_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_fO_=ty1[1];
          if(typeof match === "number")
           switch$4 = 1;
          else
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_fO_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_fP_=ty1[1];
          if(typeof match === "number")
           switch$5 = 1;
          else
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_fP_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_fQ_=ty1[1];
          if(typeof match === "number")
           switch$6 = 1;
          else
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_fQ_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_fR_=ty1[1];
          if(typeof match === "number")
           switch$7 = 1;
          else
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_fR_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_fS_=ty1[1];
          if(typeof match === "number")
           switch$8 = 1;
          else
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_fS_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_fT_=ty1[2],_fU_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_fV_=trans(_fT_,rest2$7);
              return [8,trans(_fU_,ty2),_fV_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_fW_=ty1[3],_fX_=ty1[2],_fY_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_fX_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_fY_,ty22,trans(_fW_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_fZ_,rest2$9)]}
          throw [0,Assert_failure,_aa_];
         case 11:
          var switch$11=0,_f0_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_f0_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_ab_];
          break;
         case 12:
          var switch$12=0,_f1_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_f1_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ac_];
          break;
         case 13:
          var switch$13=0,_f2_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_f2_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ad_];
          break;
         default:
          var switch$14=0,_f3_=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_f3_,rest2$13)];
             default:switch$14 = 1}
        ...
        {case 0:
         ...
         case 9:
          var
           ...
           _fA_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _fB_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _fC_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _fD_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _fE_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _fF_=function(param){caml_call1(de$12,0);return 0},
           _fG_=function(param){caml_call1(ed$12,0);return 0},
           _fH_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _fI_=function(param){caml_call1(de$13,0);return 0},
           _fJ_=function(param){caml_call1(ed$13,0);return 0},
           _fK_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       {if(prec)
         {var _fm_=match[2];
          if(typeof _fm_ !== "number" && 2 === _fm_[0])
           {var rest=_fm_[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _fk_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_fk_))
             throw Type_mismatch;
            var _fl_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_fl_))
             throw Type_mismatch;
            var
         ...
         case 4:
          ...
          if(typeof _e9_ !== "number" && 2 === _e9_[0])
           {var
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_e8_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
          ...
          if(typeof _e$_ !== "number" && 3 === _e$_[0])
           {var
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_e__,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           _fb_=match$9[3],
           _fa_=match$9[1];
          if(typeof _fb_ !== "number" && 4 === _fb_[0])
           {var
             fmtty_rest$5=_fb_[1],
             prec$4=match$9[2],
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_fa_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           _fd_=match$11[3],
           _fc_=match$11[1];
          if(typeof _fd_ !== "number" && 5 === _fd_[0])
           {var
             fmtty_rest$6=_fd_[1],
             prec$6=match$11[2],
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_fc_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
          ...
          if(typeof _ff_ !== "number" && 6 === _ff_[0])
           {var
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_fe_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           ...
           _fh_=match$15[2],
           _fg_=match$15[1];
          if(typeof _fh_ !== "number" && 7 === _fh_[0])
           {var
             fmtty_rest$8=_fh_[1],
             match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$16[2],
             fmt$9=match$16[1];
            return [0,[9,_fg_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _fj_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_fj_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_fj_[1];
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _e1_ >>> 0)
           {if(33 < (_e1_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _e1_)switch$0 = 1;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _eU_=caml_ml_bytes_length(s$0) - 1 | 0,
           _eT_=0;
          if(! (_eU_ < 0))
           {var i$0=_eT_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _eY_=match - 34 | 0,switch$2=0;
                if(58 < _eY_ >>> 0)
                 {if(93 <= _eY_)switch$2 = 1}
                else
                 if(56 < (_eY_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
                if(! switch$2){var _eZ_=1;switch$1 = 2}}
              else
               if(11 <= match)
              ...
              switch(switch$1)
               {case 0:var _eZ_=4;break;case 1:var _eZ_=2;break}
              n[1] = n[1] + _eZ_ | 0;
              var _e0_=i$0 + 1 | 0;
          ...
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _eW_=caml_ml_bytes_length(s$0) - 1 | 0,_eV_=0;
            if(! (_eW_ < 0))
             {var i=_eV_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i),switch$3=0;
                ...
                break}}
            var _e2_=s}
          var str$0=caml_string_of_bytes(_e2_)}
    ...
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_eO_=caml_ml_string_length(s) - 1 | 0,_eN_=0;
        if(! (_eO_ < 0))
         {var i$0=_eN_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _eS_=i$0 + 1 | 0;
            if(_eO_ !== i$0){var i$0=_eS_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _eQ_=caml_ml_string_length(s) - 1 | 0,
         _eP_=0;
        if(! (_eQ_ < 0))
         {var i=_eP_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _eM_=_ah_;break;
        case 2:var _eM_=_ai_;break;
        case 4:var _eM_=_ak_;break;
        case 5:var _eM_=_al_;break;
        case 6:var _eM_=_am_;break;
        case 7:var _eM_=_an_;break;
        case 8:var _eM_=_ao_;break;
        case 9:var _eM_=_ap_;break;
        case 10:var _eM_=_aq_;break;
        case 11:var _eM_=_ar_;break;
        case 0:
        case 13:var _eM_=_ag_;break;
        case 3:
        case 14:var _eM_=_aj_;break;
        default:var _eM_=_as_}
      return transform_int_alt(iconv,caml_format_int(_eM_,n))}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _eL_=_aH_;break;
        case 2:var _eL_=_aI_;break;
        case 4:var _eL_=_aK_;break;
        case 5:var _eL_=_aL_;break;
        case 6:var _eL_=_aM_;break;
        case 7:var _eL_=_aN_;break;
        case 8:var _eL_=_aO_;break;
        case 9:var _eL_=_aP_;break;
        case 10:var _eL_=_aQ_;break;
        case 11:var _eL_=_aR_;break;
        case 0:
        case 13:var _eL_=_aG_;break;
        case 3:
        case 14:var _eL_=_aJ_;break;
        default:var _eL_=_aS_}
      return transform_int_alt(iconv,caml_format_int(_eL_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _eK_=_aU_;break;
        case 2:var _eK_=_aV_;break;
        case 4:var _eK_=_aX_;break;
        case 5:var _eK_=_aY_;break;
        case 6:var _eK_=_aZ_;break;
        case 7:var _eK_=_a0_;break;
        case 8:var _eK_=_a1_;break;
        case 9:var _eK_=_a2_;break;
        case 10:var _eK_=_a3_;break;
        case 11:var _eK_=_a4_;break;
        case 0:
        case 13:var _eK_=_aT_;break;
        case 3:
        case 14:var _eK_=_aW_;break;
        default:var _eK_=_a5_}
      return transform_int_alt(iconv,caml_format_int(_eK_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _eJ_=_au_;break;
        case 2:var _eJ_=_av_;break;
        case 4:var _eJ_=_ax_;break;
        case 5:var _eJ_=_ay_;break;
        case 6:var _eJ_=_az_;break;
        case 7:var _eJ_=_aA_;break;
        case 8:var _eJ_=_aB_;break;
        case 9:var _eJ_=_aC_;break;
        case 10:var _eJ_=_aD_;break;
        case 11:var _eJ_=_aE_;break;
        case 0:
        case 13:var _eJ_=_at_;break;
        case 3:
        case 14:var _eJ_=_aw_;break;
        default:var _eJ_=_aF_}
      return transform_int_alt(iconv,caml_int64_format(_eJ_,n))}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _eG_ >>> 0)
              {if(55 === _eG_)switch$0 = 1}
             else
              if(21 < (_eG_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _eH_=1}
           var _eI_=_eH_?str:symbol(str,_a6_);
           return caml_special_val(_eI_)}
        case 6:return hex(0);
        case 7:
         ...
         if(0 === l)
          ...
          {var r=caml_create_bytes(l),_eC_=l - 1 | 0,_eB_=0;
           if(! (_eC_ < 0))
            {var i=_eB_;
             for(;;)
              {var
                ...
                switcher=c - 97 | 0,
                _eD_=25 < switcher >>> 0?c:c - 32 | 0;
               caml_bytes_unsafe_set(r,i,_eD_);
               var _eE_=i + 1 | 0;
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_ew_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_ew_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _et_=[8,acc,_be_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_et_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_et_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_es_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_es_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_ek_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_ek_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bm_;
      ...
      return caml_call2(sprintf(_bn_),_ej_,_ei_)}
       ...
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          ...
          _ee_=field(e,1),
          _eg_=caml_call2(sprintf(_bo_),_ee_,_ed_);
        else
         switch(match)
          {case 0:var _eg_=_bp_;break;
           case 1:var _eg_=_bq_;break;
           default:var _ef_=field(e,1),_eg_=caml_call1(sprintf(_br_),_ef_)}
        return symbol(constructor,_eg_)}
      return e[1]}
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _eb_=a.length - 1 - 1 | 0,_ea_=0;
        if(! (_eb_ < 0))
         {var i=_ea_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _d5_=slot[4],
              _d6_=slot[3],
              _d7_=slot[6]?_bB_:_bD_,
              _d8_=slot[2],
              _d9_=slot[7],
              _d__=info(slot[1]),
              match=
               [0,
                caml_call7(sprintf(_bC_),_d__,_d9_,_d8_,_d7_,_d6_,_d5_,_d4_)];
            else
             if(slot[1])
              var match=0;
             else
              var _d$_=info(0),match=[0,caml_call1(sprintf(_bE_),_d$_)];
            if(match){var str=match[1];caml_call1(fprintf(outchan,_bF_),str)}
            var _ec_=i + 1 | 0;
            if(_eb_ !== i){var i=_ec_;continue}
            break}}
        return 0}
      return fprintf(outchan,_bG_)}
    function register_printer(fn){printers[1] = [0,fn,printers[1]];return 0}
    var
     t2=joo_global_object,
     no_handler=null,
    ...
    function unsafeCreateElementEx(type,name,doc,elt)
     {for(;;)
       {if(0 === type && 0 === name)return createElement(doc,elt);
        var _dY_=createElementSyntax[1];
        if(785140586 === _dY_)
         {try
           {var
             el=t15.createElement('<input name="x">'),
             _d1_=el.tagName.toLowerCase() === "input"?1:0,
             _d2_=_d1_?el.name === "x"?1:0:_d1_,
             _dZ_=_d2_}
          catch(_d3_){var _dZ_=0}
          var _d0_=_dZ_?982028505:-1003883683;
          createElementSyntax[1] = _d0_;
          continue}
        if(982028505 <= _dY_)
        ...
        return res}}
    function createDiv(doc){return unsafeCreateElement(doc,_bJ_)}
    caml_fresh_oo_id(0);
     ...
     {var _dX_=p[1];
      switch(_dX_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_dX_[1],p$1=underlying(p$0);
    ...
    var Canceled=[248,_bP_,caml_fresh_oo_id(0)];
      ...
      switch(_dP_[0])
       {case 1:
         return _dP_[1] === Canceled
                 ?0
                 :caml_call1(ksprintf(invalid_arg,_bR_),api_function_name);
        case 2:var result=[0,v];resolve(_bS_,0,p,result);return 0;
        default:
         return caml_call1(ksprintf(invalid_arg,_bQ_),api_function_name)}}
    ...
    function make_into_proxy(outer_promise,user_provided_promise)
     {var p=underlying(user_provided_promise);
      ...
      var _dO_=p[1];
      switch(_dO_[0])
       {case 1:return resolve(_bU_,0,outer_promise,p[1]);
        case 2:
         var
          p_callbacks=_dO_[1],
        ...
        default:return resolve(_bT_,0,outer_promise,p[1])}}
      ...
      function create_result_promise_and_call(param)
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
           {var p$2=underlying(p);resolve(_bV_,0,p$2,p_result);return 0}
          var v=p_result[1];
       ...
       {case 1:return [0,_dJ_];
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_bW_,function(param){return caml_call1(f,v)},_dK_)}}
    var pause_hook=[0,function(_dH_){return 0}],s1=create(0),_bZ_=[0,0];
    function wakeup_paused(param)
     {if(s1[2] === s1){_bZ_[1] = 0;return 0}
      var seq=create(0);
      seq[1][2] = s1[2];
      s1[2][1] = seq[1];
      seq[1] = s1[1];
    ...
    function sleep(d)
     {var t=new_pending(1),d$0=d * 1000.;
      function callback(_dF_){return wakeup(t,_dF_)}
      var id=[0,0];
      function loop(step,param)
       {if(2147483000. < step)
        ...
        var
         cb=remain == 0.?callback:function(_dE_){return loop(remain,_dE_)},
      ...
      function f(param)
       {var _dD_=id[1];
        if(_dD_){var x=_dD_[1];id[1] = 0;return t2.clearTimeout(x)}
        return 0}
      var p=underlying(t),_dB_=p[1];
      switch(_dB_[0])
       {case 1:
         if(_dB_[1] === Canceled)
          {var
    ...
    function count(c,s)
     {var n=[0,0],_dz_=caml_ml_string_length(s) - 1 | 0,_dy_=0;
      if(! (_dz_ < 0))
       {var i=_dy_;
        for(;;)
    ...
    function push(c,v)
     {var _dw_=c[12];
      ...
      var _dx_=c[7];
      c[7] = [0,caml_call1(c[1][21],v),_dx_];
      return 0}
    ...
    function style_change(c,style)
     {var _du_=style?c[2]:c[3];
      if(_du_)
       {var _dv_=c[12];
        if(typeof _dv_ !== "number" && 0 === _dv_[0])
         {var stack=_dv_[3],inline=_dv_[2],s=_dv_[1];
          if(s === style)return pop_style(c,style,inline,stack)}
        return style?push_string(c,_b1_):push_string(c,_b2_)}
      c[12] = [0,style,c[7],c[12]];
      c[7] = 0;
      return set_style(c,style,1)}
    function pop_link(c,addr,stack)
     {c[12] = stack;
      var _ds_=c[7],_dt_=rev(c[8]);
      c[7] = [0,caml_call2(c[1][7],addr,_dt_),_ds_];
      c[8] = 0;
      c[5] = 0;
      return 0}
     ...
     {var _dp_=c[12];
      if(typeof _dp_ !== "number")
       switch(_dp_[0])
        {case 5:
          var _dq_=c[12];
          c[12] = [6,[0,[0,0,rev(c[7])],0],_dq_];
          c[7] = 0;
          return 1;
         case 6:return 1;
         case 7:
          var _dr_=_dp_[2];
          if(typeof _dr_ !== "number" && 6 === _dr_[0])
           {var stack=_dr_[2],entries=_dr_[1],heading=_dp_[1];
        ...
        if(typeof _dn_ !== "number")
         switch(_dn_[0])
          {case 5:return 1;
           case 6:
            var _do_=_dn_[2];
            if(typeof _do_ !== "number" && 5 === _do_[0])
             {var rows=_do_[1],entries=_dn_[1];
     ...
     {for(;;)
       {var _dd_=c[12];
        if(typeof _dd_ === "number")
         {if(0 !== c[7])
           {var _de_=c[11],_df_=rev(c[7]);
            c[11] = [0,caml_call1(c[1][9],_df_),_de_];
            c[7] = 0}
          c[12] = 0;
          return 0}
        else
         switch(_dd_[0])
          {case 0:
            var stack=_dd_[3],inline=_dd_[2],style=_dd_[1];
            pop_style(c,style,inline,stack);
            continue;
           case 1:
            var stack$0=_dd_[2],addr=_dd_[1];
            pop_link(c,addr,stack$0);
            continue;
           case 2:
            var l=_dd_[1],switcher=l - 1 | 0;
            if(4 < switcher >>> 0)
             var f=c[1][16];
            else
             switch(switcher)
            ...
            var _dg_=c[11];
            c[11] = [0,caml_call1(f,rev(c[7])),_dg_];
            c[7] = 0;
            c[4] = 0;
            c[12] = 0;
            return 0;
           case 3:
            var stack$1=_dd_[1],_dh_=c[10];
            c[10] = [0,[0,rev(c[7]),0],_dh_];
            c[12] = stack$1;
            c[7] = 0;
            continue;
           case 4:
            var stack$2=_dd_[3],lst=_dd_[2],kind=_dd_[1],_di_=lev < c[6]?1:0;
            if(_di_)
             {c[6] = c[6] - 1 | 0;
              var
              ...
              if(0 === c[6])
               ...
               {var switch$0=0;
                if(lst)
                 {var _dj_=lst[1];
                  if(! _dj_[2])
                   {var rem=lst[2],l$0=_dj_[1];
                    c[10] = [0,[0,l$0,[0,cur_lst]],rem];
                    switch$0 = 1}}
                if(! switch$0)throw [0,Assert_failure,_b4_]}
              c[12] = stack$2;
              continue}
            return _di_;
           case 5:
            var rows=_dd_[1],_dk_=c[11],_dl_=rev(rows);
            c[11] = [0,caml_call1(c[1][20],_dl_),_dk_];
            c[12] = 0;
            return 0;
           case 6:throw [0,Assert_failure,_b5_];
           default:close_row(c);continue}}}
    function start_list_item(c,kind,lev)
     {var _da_=lev === (c[6] + 1 | 0)?1:0,switch$0=0;
      if(_da_)
       var _db_=_da_;
      else
       {var _dc_=lev <= c[6]?1:0;
        if(_dc_)
         {var n$1=c[6] - lev | 0,stack=c[12],n=n$1;
          for(;;)
           {var switch$1=0;
            ...
            if(! switch$1)throw [0,Assert_failure,_b6_];
            break}}
        else
         var _db_=_dc_}
      if(! switch$0)var correct=_db_;
    ...
    function start_table_row(c,heading)
     {if(1 - close_row(c)){end_paragraph(c,0);c[12] = _b7_}
          ...
          switch(ocaml_lex_state$0)
           {case 0:end_paragraph(c,0);continue a;
            ...
            case 4:
             end_paragraph(c,0);
             var _c7_=c[11];
             c[11] = [0,caml_call1(c[1][19],0),_c7_];
             continue a;
            case 5:
             end_paragraph(c,0);
             b:
               ...
               for(;;)
                {var
                 ...
                 switch(ocaml_lex_state$2)
                  {case 0:
                    var s$0=lexeme(lexbuf),_c8_=c[9];
                    c[9]
                    =
                    [0,sub$0(s$0,1,caml_ml_string_length(s$0) - 1 | 0),_c8_];
                    continue b;
                   case 1:
                    var _c9_=c[11],_c__=rev(c[9]);
                    c[11] = [0,caml_call1(c[1][10],_c__),_c9_];
                    c[9] = 0;
                    if(counter < 50)
                     {var counter$6=counter + 1 | 0;
                   ...
                   default:
                    var _c$_=c[9];c[9] = [0,lexeme(lexbuf),_c$_];continue b}}}
            case 6:
             start_table_row(c,0);
             if(counter < 50)
              {var counter$3=counter + 1 | 0;
           ...
           {case 0:
            ...
            case 4:
             ...
             var
              ...
              _cV_=c[7],
              _cW_=[0,caml_call1(c[1][1],addr),0];
            ...
            case 5:
             ...
             var
              ...
              _cX_=c[7],
              _cY_=[0,caml_call1(c[1][1],addr$0),0];
             c[7] = [0,caml_call2(c[1][8],addr$0,_cY_),_cX_];
             continue a;
            case 6:
             if(c[5])
              push_chars(c,lexbuf);
             ...
             continue a;
            case 7:
             var _cZ_=c[12],switch$0=0;
             if(typeof _cZ_ !== "number" && 1 === _cZ_[0])
              {var stack=_cZ_[2],addr$2=_cZ_[1];
            ...
            case 8:
             ...
             var
              ...
              _c0_=c[7],
              _c1_=[0,caml_call1(c[1][1],addr$3),0];
             c[7] = [0,caml_call2(c[1][7],addr$3,_c1_),_c0_];
             continue a;
            ...
            case 11:
             var
              ...
              _c2_=caml_call1(c[1][1],txt),
              _c3_=[0,caml_call1(c[1][21],_c2_),0];
             push(c,caml_call1(c[1][6],_c3_));
             continue a;
            case 12:
        ...
        map
         (function(param)
           {var l=param[2],c=param[1];
            if(l)var v=l[1],_cT_=[0,v,0];else var _cT_=0;
            var _cU_=append(c,_cT_);
            return symbol$0(d.createElement("li"),_cU_)},
          c),
       t0=caml_jsstring_of_string(tag);
      return symbol$0(d.createElement(t0),_cS_)}
    function _b__(x){return x}
    function _b$_(rows)
     {var
       rows$0=
        map
              ...
              map
               (function(param)
                 {var
                   ...
                   h=param[1],
                   kind=h?_ca_:_cb_,
                   t54=caml_jsstring_of_string(kind);
                  return symbol$0(t15.createElement(t54),c)},
                entries);
            return symbol$0(t15.createElement("tr"),_cR_)},
          rows),
       _cQ_=[0,symbol$0(t15.createElement("tbody"),rows$0),0];
      return symbol$0(t15.createElement("table"),_cQ_)}
    function _cc_(param){return t15.createElement("hr")}
    function _cd_(s){return list_builder(t15,_ce_,s)}
    function _cf_(s){return list_builder(t15,_cg_,s)}
    function _ch_(s){return symbol$0(t15.createElement("h6"),s)}
    function _ci_(s){return symbol$0(t15.createElement("h5"),s)}
    function _cj_(s){return symbol$0(t15.createElement("h4"),s)}
    function _ck_(s){return symbol$0(t15.createElement("h3"),s)}
    function _cl_(s){return symbol$0(t15.createElement("h2"),s)}
    function _cm_(s){return symbol$0(t15.createElement("h1"),s)}
    function _cn_(s)
     {var p=t15.createElement("pre");
      if(s)
         ...
         {if(param)
           {var _cM_=param[1];
            if(param[2])
             {var
               tl=param[2],
               x=(caml_ml_string_length(_cM_) | 0) + acc | 0,
               acc$0=acc <= x?x:invalid_arg(_n_),
               acc=acc$0,
               param=tl;
              continue}
            var _cO_=caml_ml_string_length(_cM_) + acc | 0}
          else
           var _cO_=acc;
          var dst=caml_create_bytes(_cO_),pos=pos$1,param$0=s;
          for(;;)
           {if(param$0)
             {var _cN_=param$0[1];
              if(param$0[2])
               {var tl$0=param$0[2];
                caml_blit_string(_cN_,0,dst,pos,caml_ml_string_length(_cN_));
                caml_blit_string
                 (sep,0,dst,pos + caml_ml_string_length(_cN_) | 0,0);
                var
                 pos$0=pos + caml_ml_string_length(_cN_) | 0 | 0,
                 pos=pos$0,
                 param$0=tl$0;
                continue}
              caml_blit_string(_cN_,0,dst,pos,caml_ml_string_length(_cN_))}
            var _cP_=caml_string_of_bytes(dst);
            break}
          break}}
      else
       var _cP_=_o_;
      var t30=caml_jsstring_of_string(_cP_);
      appendChild(p,t15.createTextNode(t30));
      return p}
    function _co_(s){return symbol$0(t15.createElement("p"),s)}
    function _cp_(addr,s)
     {var i=unsafeCreateElement(t15,_bN_);
      i.width = "480";
      i.height = "360";
      var
       s$0=caml_jsstring_of_string(addr),
       video_link=symbol(_cq_,caml_string_of_jsstring(t2.encodeURI(s$0)));
      i.src = caml_jsstring_of_string(video_link);
      i.frameBorder = "0";
      return i}
    function _cr_(addr,s)
     {var a=unsafeCreateElement(t15,_bL_);
      a.href = caml_jsstring_of_string(addr);
      return symbol$0(a,s)}
    function _cs_(s){return symbol$0(t15.createElement("tt"),s)}
    function _ct_(addr,alt)
     {var i=unsafeCreateElement(t15,_bM_);
      i.src = caml_jsstring_of_string(addr);
      i.alt = caml_jsstring_of_string(alt);
      return i}
    function _cu_(param){return t15.createElement("br")}
    function _cv_(s){return symbol$0(t15.createElement("em"),s)}
    function _cw_(s){return symbol$0(t15.createElement("strong"),s)}
    var
     b=
      [0,
       function(s)
        {var t4=caml_jsstring_of_string(s);return t15.createTextNode(t4)},
       _cw_,
       _cv_,
       _cu_,
       _ct_,
    ...
    function xml_of_wiki(s)
     {var
       ...
       _cI_=0,
       _cJ_=0,
       _cK_=caml_ml_string_length(s),
       _cC_=copy(caml_bytes_of_string(s)),
       lexbuf=
        [0,
      ...
      parse_bol(c,lexbuf);
      var _cL_=rev(c[11]);
      return symbol$0(createDiv(t15),_cL_)}
    function replace_child(p,n)
     {var c=p.firstChild;
      if(1 - (c == no_handler?1:0))p.removeChild(c);
      return appendChild(p,n)}
    function f$0(param)
     {var body=t15.getElementById("wiki_demo");
      if(body == no_handler)throw [0,Assert_failure,_cx_];
      var textbox=unsafeCreateElementEx(0,0,t15,_bI_);
      textbox.rows = 20;
      textbox.cols = 80;
      textbox.value
      =
      ...
      var preview=createDiv(t15);
      preview.style.border = "1px black dashed";
      preview.style.padding = "5px";
      appendChild(body,textbox);
      appendChild(body,unsafeCreateElement(t15,_bK_));
      ...
      function dyn_preview(old_text,n)
       {var text=caml_string_of_jsstring(textbox.value);
        if(caml_string_notequal(text,old_text))
         ...
         var n$0=max(0,n - 1 | 0);
        function _cz_(param){return dyn_preview(text,n$0)}
        var _cA_=0 === n$0?0.5:0.1;
        return symbol_bind(sleep(_cA_),_cz_)}
      dyn_preview(_cy_,0);
      return false$0}
    t2.onload
    =
