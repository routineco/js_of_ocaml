...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     git_version=caml_string_of_jsbytes("cde86b2cb"),
    ...
    var t5=joo_global_object,t58=null,t39=undefined;
    ...
    var t44=t5.Float32Array,onIE=caml_js_on_ie(0) | 0,t50=t5.document;
    caml_fresh_oo_id(0);
    var
    ...
    function unsafeCoerce(tag,e)
     {var t56=e.tagName,_eO_=caml_jsstring_of_string(tag);
      return t56.toLowerCase() === _eO_?e:t58}
    ...
    ({"alpha":t11,
      ...
      "stencil":t127,
      "antialias":t11,
      "premultipliedAlpha":t127,
      "preserveDrawingBuffer":t127,
      "preferLowPowerToHighPerformance":t127,
      "failIfMajorPerformanceCaveat":t127});
    ...
    function string_match(r,s,i)
     {r.lastIndex = i;
      var t11=caml_jsbytes_of_string(s),x=r.exec(t11),_eN_=x == t58?t58:x;
      return to_option(_eN_)}
    function matched_group(r,i)
     {var x=r[i],_eM_=x === t39?t39:caml_string_of_jsbytes(x);
    ...
    var t50$0=caml_jsbytes_of_string(s);
    regexp(caml_string_of_jsbytes(t50$0.replace(t48,"\\$&")));
    var t14=new t22("\\+","g");
    ...
    if(x !== t39)
     ...
     var
      t42=function(param,_eK_){return 0},
      t41=function(param,_eJ_){return 0},
    ...
    var t49=_bT_.search;
    if(t49.charAt(0) === "?")
     var t52=_bT_.search,_bV_=t52.slice(1);
    else
            ...
            function(s)
             {function _eD_(param)
              ...
              if(t5 < 0)
               ...
               var t7=t5 + 1 | 0,_eB_=s.slice(t7),_eC_=[0,s.slice(0,t5),_eB_];
    ...
    function init_canvas(canvas_id)
     {function _d1_(param){return caml_call1(error(_ch_),canvas_id)}
      var
       canvas$0=
        get
         (bind(t50.getElementById(caml_jsstring_of_string(canvas_id)),canvas),
          _d1_);
      function _d2_(param)
       {return ksprintf
                (function(s)
                  {var t4=caml_jsstring_of_string(s);
                   ...
                   return failwith(s)},
                 f$0)}
      try {var _d4_=getContext(canvas$0),_d3_=_d4_}catch(_d5_){var _d3_=t58}
    ...
    function load_shader(gl,shader,text)
     {gl.shaderSource(shader,text);
      ...
      var
       ...
       _dY_=1 - (gl.getShaderParameter(shader,t17) | 0);
      if(_dY_)
       {var
    ...
    function get_source(src_id)
     {function _dX_(param){return caml_call1(error(_ck_),src_id)}
      var
       ...
       script$0=get(bind(t50.getElementById(t40),script),_dX_);
         ...
         headers$0=
          function(s)
           {function _dz_(v){return [0,caml_string_of_jsstring(v)]}
            ...
            return case$0(t59.getResponseHeader(t35),_dA_,_dz_)},
         st=[0,382334108],
         do_check_headers=
          function(param)
           {if(382334108 === st[1])
              ...
              case 4:
               ...
               if(_dy_)
                {var
                  ...
                  _dv_=
                   function(param)
                    {var match=to_option(t59.responseXML);
                     if(match)
                      {var doc=match[1];
    ...
    function start(param)
     {var
       norm=param[2],
       pos=param[1],
       fps_text=t50.createTextNode("loading"),
       span=bind(t50.getElementById("fps"),element);
      if(1 - (span == t58?1:0))span.appendChild(fps_text);
      debug(_ct_);
      ...
      var t98=gl.createProgram();
      gl.attachShader(t98,t29);
      gl.attachShader(t98,t32);
      gl.linkProgram(t98);
      var t38=gl.LINK_STATUS;
      if(1 - (gl.getProgramParameter(t98,t38) | 0))error(_cj_);
      debug(_cy_);
      gl.useProgram(t98);
      check_error(gl);
      debug(_cz_);
      var t54=gl.DEPTH_TEST;
      gl.enable(t54);
      var t57=gl.LESS;
      gl.depthFunc(t57);
      var
       t126=gl.getUniformLocation(t98,"u_proj"),
       t68=gl.getUniformLocation(t98,"u_lightPos"),
       t71=gl.getUniformLocation(t98,"u_ambientLight"),
       t69=float32array([254,3.,0.,-1.]),
       t72=float32array([254,0.1,0.1,0.1]);
      gl.uniform3fv(t68,t69);
      gl.uniform3fv(t71,t72);
      var t91=gl.getAttribLocation(t98,"a_position");
      gl.enableVertexAttribArray(t91);
      var t82=gl.createBuffer(),t81=gl.ARRAY_BUFFER;
      gl.bindBuffer(t81,t82);
      var t88=gl.STATIC_DRAW,t86=gl.ARRAY_BUFFER;
      gl.bufferData(t86,pos,t88);
      var t93=gl.FLOAT;
      gl.vertexAttribPointer(t91,3,t93,t127,0,0);
      var t115=gl.getAttribLocation(t98,"a_normal");
      gl.enableVertexAttribArray(t115);
      var t106=gl.createBuffer(),t105=gl.ARRAY_BUFFER;
      gl.bindBuffer(t105,t106);
      var t112=gl.STATIC_DRAW,t110=gl.ARRAY_BUFFER;
      gl.bufferData(t110,norm,t112);
      var t117=gl.FLOAT;
      gl.vertexAttribPointer(t115,3,t117,t127,0,0);
      var
       mat=
        mult
         ([254,
      ...
      check_error(gl);
      debug(_cA_);
      function get_time(param){var t123=new t124();return t123.getTime()}
      var last_draw=[0,get_time(0)],q=create(0);
      function f(param)
       {var
         t125=new t124(),
         t$0=t125.getTime() / 1000.,
         t$1=1. * t$0,
         m=
          mult
           (mat,
            [254,
             ...
             1.]),
         t128=float32array(m);
        gl.uniformMatrix4fv(t126,t127,t128);
        var t132=gl.DEPTH_BUFFER_BIT | gl.COLOR_BUFFER_BIT;
        gl.clear(t132);
        var t138=pos.length / 3 | 0,t136=gl.TRIANGLES;
        gl.drawArrays(t136,0,t138);
        check_error(gl);
        var now=get_time(0);
           ...
           {var r=regexp(_cs_);
            ...
            for(;;)
             {if(idx < 0)
              ...
              if(x === t39)throw [0,Assert_failure,_bL_];
              var
