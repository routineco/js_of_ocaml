...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _bR_=caml_string_of_jsbytes("Random.int"),
     _bK_=caml_string_of_jsbytes("x"),
     _bS_=
      [0,
       987910699,
       495797812,
       ...
       409934019,
       801085050],
     _bT_=caml_string_of_jsbytes("Js_of_ocaml__Js.Error"),
     _bU_=caml_string_of_jsbytes("Js_of_ocaml__Dom_html.Canvas_not_available"),
     _b4_=[0,0],
     _b5_=[0,1],
     _b2_=[0,0],
     _b3_=[0,1],
     ...
     _bY_=
      [0,
       ...
       caml_string_of_jsbytes("Lwt.%s")],
     _bZ_=[0,0],
     _bV_=caml_string_of_jsbytes("Fatal error: exception "),
     _bW_=caml_string_of_jsbytes("Lwt.Resolution_loop.Canceled"),
     _b7_=caml_string_of_jsbytes("Exception during Lwt.async: ");
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_eX_ = caml_wrap_exception(_eX_);
              if(_eX_[1] !== Sys_error)throw _eX_;
              var _eW_=_eX_}
            var param$0=l;
            continue}
          return 0}}
     ...
     {var switch$0=0;
      if
       ...
       {var r=caml_create_bytes(len);
        ...
        var _eV_=r;
        switch$0 = 1}
      if(! switch$0)var _eV_=invalid_arg(_k_);
      return caml_string_of_bytes(_eV_)}
    ...
    function init(l,f)
     {if(0 === l)return [0];
      if(0 <= l)
       {var res=caml_make_vect(l,caml_call1(f,0)),_eT_=l - 1 | 0,_eS_=1;
        if(! (_eT_ < 1))
         {var i=_eS_;
          for(;;)
    ...
    function add(x,q)
     {var cell=[0,x,0],_eR_=q[3];
      return _eR_
              ?(q[1] = q[1] + 1 | 0,_eR_[2] = cell,q[3] = cell,0)
       ...
       switch(ty1[0])
        {case 0:
         ...
         case 3:
          ...
          break;
         case 4:
          var switch$5=0,_eA_=ty1[1];
          if(typeof match === "number")
           switch$5 = 1;
          else
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_eA_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_eB_=ty1[1];
          if(typeof match === "number")
           switch$6 = 1;
          else
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_eB_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_eC_=ty1[1];
          if(typeof match === "number")
           switch$7 = 1;
          else
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_eC_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_eD_=ty1[1];
          if(typeof match === "number")
           switch$8 = 1;
          else
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_eD_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_eE_=ty1[2],_eF_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_eG_=trans(_eE_,rest2$7);
              return [8,trans(_eF_,ty2),_eG_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_eH_=ty1[3],_eI_=ty1[2],_eJ_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_eI_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_eJ_,ty22,trans(_eH_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_eK_,rest2$9)]}
          throw [0,Assert_failure,_$_];
         case 11:
          var switch$11=0,_eL_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_eL_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_aa_];
          break;
         case 12:
          var switch$12=0,_eM_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_eM_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ab_];
          break;
         case 13:
          var switch$13=0,_eN_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_eN_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ac_];
          break;
         default:
          var switch$14=0,_eO_=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_eO_,rest2$13)];
             default:switch$14 = 1}
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         _d__=function(param){return 0},
         _d$_=function(param){return 0},
         _ea_=function(param){return 0};
       ...
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _eb_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_eb_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _ec_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _ed_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _ee_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _ef_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _eg_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _eh_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _ei_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _ej_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _ek_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _el_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _em_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _en_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _eo_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _ep_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _eq_=function(param){caml_call1(de$12,0);return 0},
           _er_=function(param){caml_call1(ed$12,0);return 0},
           _es_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _et_=function(param){caml_call1(de$13,0);return 0},
           _eu_=function(param){caml_call1(ed$13,0);return 0},
           _ev_=function(param){caml_call1(af$13,0);return 0};
          return [0,
    ...
    function type_padprec(pad,prec,fmtty)
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(prec)
         {var _d9_=match[2];
          if(typeof _d9_ !== "number" && 2 === _d9_[0])
           {var rest=_d9_[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _d7_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_d7_))
             throw Type_mismatch;
            var _d8_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_d8_))
             throw Type_mismatch;
            var
        ...
        {case 0:
         ...
         case 3:
          var
           ...
           _dS_=match$3[2],
           _dR_=match$3[1];
          if(typeof _dS_ !== "number" && 1 === _dS_[0])
           {var
             fmtty_rest$2=_dS_[1],
             match$4=type_format_gen(fmt_rest$2,fmtty_rest$2),
             fmtty$3=match$4[2],
             fmt$3=match$4[1];
            return [0,[3,_dR_,fmt$3],fmtty$3]}
          throw Type_mismatch;
         case 4:
          var
           fmt_rest$3=fmt[4],
          ...
          if(typeof _dU_ !== "number" && 2 === _dU_[0])
           {var
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_dT_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           _dW_=match$7[3],
           _dV_=match$7[1];
          if(typeof _dW_ !== "number" && 3 === _dW_[0])
           {var
             fmtty_rest$4=_dW_[1],
             prec$2=match$7[2],
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_dV_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           _dY_=match$9[3],
           _dX_=match$9[1];
          if(typeof _dY_ !== "number" && 4 === _dY_[0])
           {var
             fmtty_rest$5=_dY_[1],
             prec$4=match$9[2],
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_dX_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
          ...
          if(typeof _d0_ !== "number" && 5 === _d0_[0])
           {var
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_dZ_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           _d2_=match$13[3],
           _d1_=match$13[1];
          if(typeof _d2_ !== "number" && 6 === _d2_[0])
           {var
             fmtty_rest$7=_d2_[1],
             prec$8=match$13[2],
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_d1_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           ...
           _d4_=match$15[2],
           _d3_=match$15[1];
          if(typeof _d4_ !== "number" && 7 === _d4_[0])
           {var
             fmtty_rest$8=_d4_[1],
             match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$16[2],
             fmt$9=match$16[1];
            return [0,[9,_d3_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _d5_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_d5_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _d6_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_d6_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_d6_[1];
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _dO_=2 === padty$0?48:32,res=make(width$0,_dO_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _dM_ >>> 0)
           {if(33 < (_dM_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _dM_)switch$0 = 1;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _dF_=caml_ml_bytes_length(s$0) - 1 | 0,
           _dE_=0;
          if(! (_dF_ < 0))
           {var i$0=_dE_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _dJ_=match - 34 | 0,switch$2=0;
                if(58 < _dJ_ >>> 0)
                 {if(93 <= _dJ_)switch$2 = 1}
                else
                 if(56 < (_dJ_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
                if(! switch$2){var _dK_=1;switch$1 = 2}}
              else
               if(11 <= match)
              ...
              switch(switch$1)
               {case 0:var _dK_=4;break;case 1:var _dK_=2;break}
              n[1] = n[1] + _dK_ | 0;
              var _dL_=i$0 + 1 | 0;
              if(_dF_ !== i$0){var i$0=_dL_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _dH_=caml_ml_bytes_length(s$0) - 1 | 0,_dG_=0;
            if(! (_dH_ < 0))
             {var i=_dG_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i),switch$3=0;
                ...
                break}}
            var _dN_=s}
          var str$0=caml_string_of_bytes(_dN_)}
         ...
         {var i$0=_dy_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _dD_=i$0 + 1 | 0;
            if(_dz_ !== i$0){var i$0=_dD_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _dB_=caml_ml_string_length(s) - 1 | 0,
         _dA_=0;
        if(! (_dB_ < 0))
         {var i=_dA_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _dx_=_ag_;break;
        case 2:var _dx_=_ah_;break;
        case 4:var _dx_=_aj_;break;
        case 5:var _dx_=_ak_;break;
        case 6:var _dx_=_al_;break;
        case 7:var _dx_=_am_;break;
        case 8:var _dx_=_an_;break;
        case 9:var _dx_=_ao_;break;
        case 10:var _dx_=_ap_;break;
        case 11:var _dx_=_aq_;break;
        case 0:
        case 13:var _dx_=_af_;break;
        case 3:
        case 14:var _dx_=_ai_;break;
        default:var _dx_=_ar_}
      return transform_int_alt(iconv,caml_format_int(_dx_,n))}
    ...
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _dv_=_aT_;break;
        case 2:var _dv_=_aU_;break;
        case 4:var _dv_=_aW_;break;
        case 5:var _dv_=_aX_;break;
        case 6:var _dv_=_aY_;break;
        case 7:var _dv_=_aZ_;break;
        case 8:var _dv_=_a0_;break;
        case 9:var _dv_=_a1_;break;
        case 10:var _dv_=_a2_;break;
        case 11:var _dv_=_a3_;break;
        case 0:
        case 13:var _dv_=_aS_;break;
        case 3:
        case 14:var _dv_=_aV_;break;
        default:var _dv_=_a4_}
    ...
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _du_=_at_;break;
        ...
        case 8:var _du_=_aA_;break;
        case 9:var _du_=_aB_;break;
        case 10:var _du_=_aC_;break;
        case 11:var _du_=_aD_;break;
        case 0:
        case 13:var _du_=_as_;break;
        case 3:
        case 14:var _du_=_av_;break;
        default:var _du_=_aE_}
      return transform_int_alt(iconv,caml_int64_format(_du_,n))}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _dr_ >>> 0)
              {if(55 === _dr_)switch$0 = 1}
             else
              if(21 < (_dr_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _ds_=1}
           var _dt_=_ds_?str:symbol(str,_a5_);
           return caml_special_val(_dt_)}
        case 6:return hex(0);
        case 7:
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _di_=pad$5[2],_dj_=pad$5[1];
               if(typeof prec$3 === "number")
                return prec$3
                        ?function(p,x)
                          {var str=fix_padding(_dj_,_di_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)}
                        :function(x)
                          {var
                            str=convert_float(fconv,default_float_precision(fconv),x),
                            str$0=fix_padding(_dj_,_di_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_dj_,_di_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _dk_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(w,p,x)
                        {var str=fix_padding(_dk_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_dk_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_dk_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _dl_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _dl_[2] === "number")
              {var fmt=_dl_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_dh_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_dh_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _de_=[8,acc,_bd_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_de_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_de_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_dd_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_dd_,rest])}
           ...
           return match
                   ?function(p,x)
                     {var
                       str=
                        fix_padding
                         (_db_,_da_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(x)
                     {var str=fix_padding(_db_,_da_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_db_,_da_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _dc_=pad[1];
        if(typeof match === "number")
         return match
                 ?function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_dc_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,x)
                   {var str=fix_padding(_dc_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_dc_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
           ...
           {var
            ...
            if(0 === slot[0])
             var
              ...
              _cQ_=slot[4],
              _cR_=slot[3],
              _cS_=slot[6]?_bA_:_bC_,
              _cT_=slot[2],
              _cU_=slot[7],
              _cV_=info(slot[1]),
              match=
               [0,
                caml_call7(sprintf(_bB_),_cV_,_cU_,_cT_,_cS_,_cR_,_cQ_,_cP_)];
            else
             if(slot[1])
              var match=0;
             else
     ...
     {if(! (1073741823 < bound) && 0 < bound)
       for(;;)
        {s$0[2] = (s$0[2] + 1 | 0) % 55 | 0;
         var
          _cM_=s$0[2],
          curval=caml_check_bound(s$0[1],_cM_)[1 + _cM_],
          _cN_=(s$0[2] + 24 | 0) % 55 | 0,
          newval=
           caml_check_bound(s$0[1],_cN_)[1 + _cN_]
           +
          ...
          r=newval & 1073741823,
          _cO_=s$0[2];
         caml_check_bound(s$0[1],_cO_)[1 + _cO_] = r;
     ...
     {var _cL_=p[1];
      switch(_cL_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_cL_[1],p$1=underlying(p$0);
    ...
    function handle_with_async_exception_ho(f,v)
     {try
       {var _cK_=caml_call1(f,v);return _cK_}
      catch(exn)
    ...
    function run_callbacks(callbacks,result)
     {if(1 === result[0])
       var _cI_=result[1] === Canceled?1:0,is_canceled=_cI_;
      else
       var is_canceled=0;
      if(is_canceled)
       {var
        ...
        iter_callback_list(_cG_,0)}
      var _cH_=callbacks[1];
      ...
      return iter_callback_list$0(_cH_,0)}
    var
    ...
    for(;;)
     {caml_check_bound(s$0[1],i$0)[1 + i$0] = i$0;
      ...
      var
       ...
       create_canvas=
        function(param)
         {var doc=t2.document,c=doc.createElement("canvas");
       ...
       redraw=
        function(t135,t132,a)
         {var t127=t132.getContext("2d");
          t127.setTransform(1.,0.,0.,1.,0.,0.);
          var t119=t132.height,t118=t132.width;
          t127.clearRect(0.,0.,t118,t119);
          t127.setTransform(1.,0.,0.,1.,0.5,0.5);
          t127.globalCompositeOperation = "lighter";
          tile(t127,a,[0,draw_top,draw_right,draw_left]);
          t127.globalCompositeOperation = "source-over";
          tile(t127,a,[0,top_edges,right_edges,left_edges]);
          t127.beginPath();
          t127.moveTo(0.,360.);
          t127.lineTo(204.,480.);
          t127.lineTo(408.,360.);
       ...
       loop=
        function(c$0,c,a)
         {function f$0(param)
          ...
          function f(param)
           {var _cc_=id[1];
            if(_cc_){var x=_cc_[1];id[1] = 0;return t2.clearTimeout(x)}
            return 0}
       ...
       f$0=
        function(param)
         {var t139=create_canvas(0),c=create_canvas(0),p=t2.document.body;
          p.appendChild(t139);
          var c$0=t139.getContext("2d");
