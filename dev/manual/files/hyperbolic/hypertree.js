   ...
   {"use strict";
    ...
    function new_cache(table)
     {var n=new_method(table),switch$0=0;
      ...
      return n$0}
    var t2=joo_global_object,t58=null,undefined$0=undefined;
    function test(x){return 1 - (x == t58?1:0)}
    function iter$1(x,f)
     {var _hQ_=1 - (x == t58?1:0);return _hQ_?caml_call1(f,x):_hQ_}
     ...
     {for(;;)
       {if(0 === type && 0 === name)return createElement(doc,elt);
        ...
        if(785140586 === _hG_)
         {try
           {var
             el=t766.createElement('<input name="x">'),
    ...
    function stopPropagation(ev)
     {function _hE_(param){return ev.stopPropagation()}
      function _hF_(param){return ev.cancelBubble = t11}
     ...
     {var opt=[0,0];
      ...
      function headers$0(s)
       {function _gi_(v){return [0,caml_string_of_jsstring(v)]}
        ...
        return case$0(t59.getResponseHeader(t35),_gj_,_gi_)}
      var st=[0,382334108];
              ...
              {var
                ...
                response=
                 [0,
                  ...
                  code,
                  headers$0,
                  case$0(t59.responseText,_gf_,_ge_),
                  _gd_];
    ...
    var
     text_size_div=
      [246,
       function(_f8_)
        {var d=createDiv(t766);
         d.style.visibility = "hidden";
         d.style.position = "absolute";
         d.style.whiteSpace = "nowrap";
         appendChild(t766.body,d);
         return d}];
    function f(param)
     {function _f6_(param)
    ...
    function _cz_(st){var x=st.getItem("hyp_lang");return x == t58?f(0):x}
    ...
    function compute_text_node(info)
     {var
      ...
      d.style.font = font;
      var t119=caml_jsstring_of_string(info),txt=t766.createTextNode(t119);
      appendChild(d,txt);
      ...
      t272.fillStyle = opt_style(style.nodeBackgroundColor,tree_color);
      ...
      t272.fill();
      t272.font = font;
      t272.fillStyle = opt_style(style.nodeColor,"black");
     ...
     {try
      ...
      try
       ...
       {_fT_ = caml_wrap_exception(_fT_);
        ...
        var _fI_=_cG_}
      t766.title = caml_jsstring_of_string(_fI_);
    ...
    function close_button(over)
     {var
       ...
       t281=create_canvas(32,32),
       t305=t281.getContext("2d");
      t305.save();
      t305.lineWidth = 2.;
      t305.strokeStyle = color;
      if(over){t305.shadowBlur = 4.;t305.shadowColor = color}
      t305.beginPath();
      ...
      t281.className = caml_jsstring_of_string(_eT_);
      t281.style.position = "absolute";
      t281.style.top = "0";
      t281.style.right = "0";
      return t281}
                ...
                {var
                 ...
                 if(0 <= i[1])
                  {var
                   ...
                   var img_container=createDiv(t766);
                   ...
                   if(match)
                    {var
                      ...
                      t422=create_canvas(info[4],info[5]),
                      t428=t422.getContext("2d");
                     t428.drawImage(small_image$0,0.,0.,info[4],info[5]);
                     t422.style.display = "block";
                     t422.style.height = "auto";
                     t422.style.width = "auto";
                     t422.style.maxWidth = "100%";
                     t422.style.maxHeight = "100%";
                     t422.style.marginLeft = "auto";
                     t422.style.marginRight = "auto";
                     var w=wrap(t422);
                     appendChild(img_container,w);
                     img.onload
                     =
                     handler
                      (function(param){removeChild(img_container,w);return t238})}
                   var _eF_=info[7];
                   if(_eF_)
                   ...
                   var
                    w$0=wrap(img),
                    handle_error=
                     function(param){removeChild(img_container,w$0);return t238};
                   ...
                   var
                    ...
                    list=
                     function(title,lang)
                      {var ul=createUl(t766),empty=[0,1],_eI_=info[6];
                       iter$0
                        (function(param)
                          {var
                            refer=param[3],
                           ...
                           if(_eK_)
                            {empty[1] = 0;
                             var a=createA(t766);
                             appendChild(a,t766.createTextNode(name));
                             a.target = "_blank";
                             var
                       ...
                       if(_eJ_)
                        {count[1]++;
                         var dd=createDd(t766);
                         appendChild(dd,t766.createTextNode(title));
                         appendChild(dl,dd);
                         var dt=createDt(t766);
                         appendChild(dt,ul);
                   ...
                   if(0 < count[1])
                    ...
                    {var t568=opt_style(messages.noRef,"No reference found.");
                     appendChild(txt,t766.createTextNode(t568))}
                   txt.className = "text on";
                   ...
                   appendChild(t766.body,background);
                   background.onclick
                   =
                   handler
                    (function(param)
                      {removeChild(t766.body,background);return t11})}
                 return return$0(0)})}
            ...
            return symbol_bind
                    (all_messages,
                     function(all_messages)
                      {var page=t766.documentElement;
                       page.style.overflow = "hidden";
                       page.style.height = "100%";
                       t766.body.style.overflow = "hidden";
                       t766.body.style.margin = "0px";
                       t766.body.style.height = "100%";
                       var
                        w=page.clientWidth,
                        h=page.clientHeight,
                        canvas=create_canvas(w,h);
                       appendChild(t766.body,canvas);
                       var
                        tr=[0,[0,zero,t]],
                        tr$0=[0,tr[1]],
                        l=vertices.length - 1,
                       ...
                       function(param)
                        {need_redraw[1] = 0;
                         ...
                         var
                          ...
                          t186=canvas.height,
                          t185=canvas.width;
                         t225.clearRect(0.,0.,t185,t186);
                         var padding=opt_style(style.padding,0.);
                         t225.beginPath();
                         ellipse_arc
                          (t225,dx$1,dy$1,rx$1 + padding,ry$1 + padding,0.,7.,t238);
                         function _d7_(color)
                          {t225.fillStyle = color;return t225.fill()}
                         iter$2(style.backgroundColor,_d7_);
                         function _d8_(color)
                          {t225.lineWidth = 1.;
                           t225.strokeStyle = color;
                           return t225.stroke()}
                         iter$2(style.boundaryColor,_d8_);
                         t225.lineWidth = 2.;
                         t225.lineCap = "round";
                         t225.strokeStyle = opt_style(style.treeColor,tree_color);
                         var
                          ry$2=transf$0[2],
                          rx$2=transf$0[1],
                                ...
                                {var
                                 ...
                                 if(rx == ry)
                                  {var
                                    ...
                                    t162=z0[2] * rx + dy,
                                    t161=z0[1] * rx + dx;
                                   t225.arc(t161,t162,t163,t164,t165,t166)}
                                 else
                                  ellipse_arc
                                   (t225,
                                    z0[1] * rx + dx,
                                ...
                                {var _ec_=img[2],_ed_=_ec_[2];
                                 if(_ed_)
                                  {var
                                   ...
                                   if(circle)
                                    {t225.beginPath();
                                     ...
                                     var
                                      ...
                                      t234=z[2] * ry$2 + dy$1,
                                      t233=z[1] * rx$2 + dx$1;
                                     t225.arc(t233,t234,t235,0.,7.,t238);
                                     t225.fill()}
                                   var
                                    t245=2. * h$0,
                                    t244=2. * w$0,
                                   ...
                                   t225.drawImage(txt,t242,t243,t244,t245)}
                                 else
                                  switch$1 = 1}
                               else
                                    ...
                                    {var
                                     ...
                                     if(_ei_)
                                      {var
                                        ...
                                        t222=y$0 - h$2,
                                        t221=x$0 - w$2;
                                       t225.drawImage(img$1,t221,t222,t223,t224);
                         ...
                         switch(switcher)
                          {case 0:
                           ...
                           default:
                            ...
                            schedule_redraw(0);
                            return t238}}
                       addEventListener(t766,keydown,handler(handle_key_event),t11);
                       var prev_buttons=[0,0];
                       function make_buttons(param)
                        {var _dn_=prev_buttons[1];
                         if(_dn_){var buttons=_dn_[1];removeChild(t766.body,buttons)}
                         var buttons$0=createDiv(t766);
                         ...
                         handler
                          (function(param)
                            {show_information_page(messages,tree_i18n);return t238});
                         ...
                         var txt=createDiv(t766),dl=createDl(t766),ul=createUl(t766);
                         iter
                          (function(param)
                            {var
                              id=param[2],
                             ...
                             appendChild(a,t766.createTextNode(t758));
                             a.href = "#";
                             a.onclick
                             =
                             handler
                         ...
                         var
                          dd=createDd(t766),
                          t765=opt_style(messages.languages,"Languages");
                         appendChild(dd,t766.createTextNode(t765));
                         appendChild(dl,dd);
                         var dt=createDt(t766);
                         appendChild(dt,ul);
                         appendChild(dl,dt);
                         ...
                         appendChild(t766.body,buttons$0);
                       ...
                       appendChild(a,img);
                       var logo=createDiv(t766);
                       logo.style.position = "absolute";
                       logo.style.left = "0";
                       logo.style.bottom = "0";
                       appendChild(logo,a);
                       appendChild(t766.body,logo);
                       return return$0(0)})}),
       _dm_=underlying(p)[1];
      switch(_dm_[0])
    ...
    function start(param)
     {try
       ...
       {_dl_ = caml_wrap_exception(_dl_);
        if(_dl_ === Canvas_not_available){unsupported_messages(0);return t238}
        throw _dl_}}
