// Generated by js_of_ocaml 3.11.0+git-3.11.0-74-g6f4ab96116-dirty
(function
   (Object)
   {typeof globalThis
    !==
...
(function(globalThis)
   {"use strict";
    ...
    var
     ...
     public_methods=
      [0,
       ...
       caml_string_of_jsbytes("reload"),
       caml_string_of_jsbytes("replace")],
     s$0=caml_string_of_jsbytes("3.11.0"),
     git_version=caml_string_of_jsbytes("3.11.0-74-g6f4ab96116-dirty"),
     languages=
      [0,
       [0,
    ...
    var
     ...
     _b2_=caml_string_of_jsbytes("Js_of_ocaml__Js.Error"),
     ...
     _cM_=[0,0,0,0.],
     _cN_=[254,-1.,0.],
     _cL_=[0,caml_string_of_jsbytes("examples/hyperbolic/hypertree.ml"),967,2],
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i && ! (l < i))
       try
        {index_rec(s,l,i,c);var _li_=1;return _li_}
       catch(_lj_)
        {_lj_ = caml_wrap_exception(_lj_);
         if(_lj_ === Not_found)return 0;
         throw _lj_}
    ...
    function fold_left(f,x,a)
     {var r=[0,x],_la_=a.length - 1 - 1 | 0,_k$_=0;
      if(! (_la_ < 0))
       {var i=_k$_;
        for(;;)
    ...
    function _y_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_k__=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_k__]}
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_k5_=height(lr);
            if(_k5_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _k6_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_k6_)}
            return invalid_arg(_q_)}
          return invalid_arg(_r_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_k7_=height(rl);
            if(_k7_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _k8_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_k8_)}
            return invalid_arg(_s_)}
          return invalid_arg(_t_)}
        var _k9_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
      ...
      function min_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _k3_=param$0[1];
            if(_k3_){var param$0=_k3_;continue}
         ...
         {var _k1_=param[1];
          if(_k1_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_k1_),v,d,r)}
          var r$0=param[4];
          return r$0}
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _kY_=caml_call2(p,v,d);
            if(_kY_)
             {var _kZ_=for_all(p,l);
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _kV_=caml_call2(p,v,d);
            if(_kV_)
             var _kW_=_kV_;
            else
             {var _kX_=exists(p,l);
              if(! _kX_){var param$0=r;continue}
              var _kW_=_kX_}
            return _kW_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _kR_=merge(f,r1,r2),
             _kS_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_kS_,_kR_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _kT_=merge(f,r1$0,r2$0),
           _kU_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_kU_,_kT_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _kP_=concat(lf,rf);return [0,join(lt,v,d,rt),_kP_]}
          var _kQ_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_kQ_]}
        return _x_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _kM_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_kM_)
               {var _kN_=caml_call2(cmp,d1,d2);
                if(_kN_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function rev_seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_kF_=snoc_enum(t,rest);
          return [0,[0,k,v],function(_kG_){return rev_seq_of_enum(_kF_,_kG_)}]}
        return 0}
      function to_rev_seq(c)
       {var _kD_=snoc_enum(c,0);
        return function(_kE_){return rev_seq_of_enum(_kD_,_kE_)}}
       ...
       {var m$0=m,c=0;
        for(;;)
         {if(m$0)
           ...
           var _kB_=c;
          return function(_kC_){return seq_of_enum(_kB_,_kC_)}}}
      return [0,
              empty,
              is_empty,
              mem,
    ...
    function add(x,q)
     {var cell=[0,x,0],_kz_=q[3];
      return _kz_
              ?(q[1] = q[1] + 1 | 0,_kz_[2] = cell,q[3] = cell,0)
    ...
    function trans(ty1,ty2)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_ke_=ty1[1];
          if(typeof ty2 !== "number")
           switch(ty2[0])
            {case 0:var rest2=ty2[1];return [0,trans(_ke_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_kf_=ty1[1];
          if(typeof ty2 !== "number")
           switch(ty2[0])
            {case 1:var rest2$0=ty2[1];return [1,trans(_kf_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_kg_=ty1[1];
          if(typeof ty2 === "number")
           switch$3 = 1;
          else
           switch(ty2[0])
            {case 2:var rest2$1=ty2[1];return [2,trans(_kg_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_kh_=ty1[1];
          if(typeof ty2 === "number")
           switch$4 = 1;
          else
           switch(ty2[0])
            {case 3:var rest2$2=ty2[1];return [3,trans(_kh_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_ki_=ty1[1];
          if(typeof ty2 === "number")
           switch$5 = 1;
          else
           switch(ty2[0])
            {case 4:var rest2$3=ty2[1];return [4,trans(_ki_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_kj_=ty1[1];
          if(typeof ty2 === "number")
           switch$6 = 1;
          else
           switch(ty2[0])
            {case 5:var rest2$4=ty2[1];return [5,trans(_kj_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_kk_=ty1[1];
          if(typeof ty2 === "number")
           switch$7 = 1;
          else
           switch(ty2[0])
            {case 6:var rest2$5=ty2[1];return [6,trans(_kk_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_kl_=ty1[1];
          if(typeof ty2 === "number")
           switch$8 = 1;
          else
           switch(ty2[0])
            {case 7:var rest2$6=ty2[1];return [7,trans(_kl_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_km_=ty1[2],_kn_=ty1[1];
          if(typeof ty2 === "number")
           switch$9 = 1;
          else
           switch(ty2[0])
            {case 8:
              var rest2$7=ty2[2],ty2$0=ty2[1],_ko_=trans(_km_,rest2$7);
              return [8,trans(_kn_,ty2$0),_ko_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_kp_=ty1[3],_kq_=ty1[2],_kr_=ty1[1];
          if(typeof ty2 === "number")
           switch$10 = 1;
          else
           switch(ty2[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=ty2[2],
               ty21=ty2[1],
               ty=trans(symm(_kq_),ty21),
               match=fmtty_rel_det(ty),
               f4=match[4],
               f2=match[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_kr_,ty22,trans(_kp_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof ty2 !== "number" && 10 === ty2[0])
           {var rest2$9=ty2[1];return [10,trans(_ks_,rest2$9)]}
          throw [0,Assert_failure,_am_];
         case 11:
          var switch$11=0,_kt_=ty1[1];
          if(typeof ty2 === "number")
           switch$11 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:var rest2$10=ty2[1];return [11,trans(_kt_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_an_];
          break;
         case 12:
          var switch$12=0,_ku_=ty1[1];
          if(typeof ty2 === "number")
           switch$12 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=ty2[1];return [12,trans(_ku_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ao_];
          break;
         case 13:
          var switch$13=0,_kv_=ty1[1];
          if(typeof ty2 === "number")
           switch$13 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=ty2[1];return [13,trans(_kv_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ap_];
          break;
         default:
          var switch$14=0,_kw_=ty1[1];
          if(typeof ty2 === "number")
           switch$14 = 1;
          else
           switch(ty2[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=ty2[1];return [14,trans(_kw_,rest2$13)];
             default:switch$14 = 1}
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         ...
         _jU_=function(param){return 0};
        return [0,function(param){return 0},_jU_,_jT_,_jS_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _jV_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_jV_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _jW_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _jX_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _jY_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _jZ_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _j0_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _j1_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _j2_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _j3_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _j4_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _j5_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _j6_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _j7_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _j8_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _j9_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _j__=function(param){caml_call1(de$12,0);return 0},
           _j$_=function(param){caml_call1(ed$12,0);return 0},
           _ka_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _kb_=function(param){caml_call1(de$13,0);return 0},
           _kc_=function(param){caml_call1(ed$13,0);return 0},
           _kd_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       {if(prec)
         {var _jR_=match[2];
          if(typeof _jR_ !== "number" && 2 === _jR_[0])
           {var rest=_jR_[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
         ...
         case 9:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             _jP_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_jP_))
             throw Type_mismatch;
            var _jQ_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_jQ_))
             throw Type_mismatch;
            var
         ...
         case 4:
          ...
          if(typeof _jC_ !== "number" && 2 === _jC_[0])
           {var
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_jB_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           _jE_=match$7[3],
           _jD_=match$7[1];
          if(typeof _jE_ !== "number" && 3 === _jE_[0])
           {var
             fmtty_rest$4=_jE_[1],
             prec$2=match$7[2],
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_jD_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           _jG_=match$9[3],
           _jF_=match$9[1];
          if(typeof _jG_ !== "number" && 4 === _jG_[0])
           {var
             fmtty_rest$5=_jG_[1],
             prec$4=match$9[2],
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_jF_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
          ...
          if(typeof _jI_ !== "number" && 5 === _jI_[0])
           {var
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_jH_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           _jK_=match$13[3],
           _jJ_=match$13[1];
          if(typeof _jK_ !== "number" && 6 === _jK_[0])
           {var
             fmtty_rest$7=_jK_[1],
             prec$8=match$13[2],
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_jJ_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           ...
           _jM_=match$15[2],
           _jL_=match$15[1];
          if(typeof _jM_ !== "number" && 7 === _jM_[0])
           {var
             fmtty_rest$8=_jM_[1],
             match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$16[2],
             fmt$9=match$16[1];
            return [0,[9,_jL_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _jN_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_jN_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _jO_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_jO_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_jO_[1];
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _jw_=2 === padty$0?48:32,res=make(width$0,_jw_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _ju_ >>> 0)
           {if(33 < _ju_ - 61 >>> 0)switch$0 = 1}
          else
           if(2 === _ju_)switch$0 = 1;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _jn_=caml_ml_bytes_length(s$0) - 1 | 0,
           _jm_=0;
          if(! (_jn_ < 0))
           {var i$0=_jm_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _jr_=match - 34 | 0,switch$2=0;
                if(58 < _jr_ >>> 0)
                 {if(93 <= _jr_)switch$2 = 1}
                else
                 if(56 < _jr_ - 1 >>> 0){switch$1 = 1;switch$2 = 1}
                if(! switch$2){var _js_=1;switch$1 = 2}}
              else
               if(11 <= match)
              ...
              switch(switch$1)
               {case 0:var _js_=4;break;case 1:var _js_=2;break}
              n[1] = n[1] + _js_ | 0;
              var _jt_=i$0 + 1 | 0;
              if(_jn_ !== i$0){var i$0=_jt_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _jp_=caml_ml_bytes_length(s$0) - 1 | 0,_jo_=0;
            if(! (_jp_ < 0))
             {var i=_jo_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i),switch$3=0;
                ...
                n[1]++;
                var _jq_=i + 1 | 0;
                if(_jp_ !== i){var i=_jq_;continue}
                break}}
            var _jv_=s}
          var str$0=caml_string_of_bytes(_jv_)}
    ...
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_jh_=caml_ml_string_length(s) - 1 | 0,_jg_=0;
        if(! (_jh_ < 0))
         {var i$0=_jg_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0);
            if(! (9 < match - 48 >>> 0))n[1]++;
            var _jl_=i$0 + 1 | 0;
            if(_jh_ !== i$0){var i$0=_jl_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _jj_=caml_ml_string_length(s) - 1 | 0,
         _ji_=0;
        if(! (_jj_ < 0))
         {var i=_ji_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _jf_=_at_;break;
        case 2:var _jf_=_au_;break;
        case 4:var _jf_=_aw_;break;
        case 5:var _jf_=_ax_;break;
        case 6:var _jf_=_ay_;break;
        case 7:var _jf_=_az_;break;
        case 8:var _jf_=_aA_;break;
        case 9:var _jf_=_aB_;break;
        case 10:var _jf_=_aC_;break;
        case 11:var _jf_=_aD_;break;
        case 0:
        case 13:var _jf_=_as_;break;
        case 3:
        case 14:var _jf_=_av_;break;
        default:var _jf_=_aE_}
    ...
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 1:var _je_=_aT_;break;
        ...
        case 8:var _je_=_a0_;break;
        case 9:var _je_=_a1_;break;
        case 10:var _je_=_a2_;break;
        case 11:var _je_=_a3_;break;
        case 0:
        case 13:var _je_=_aS_;break;
        case 3:
        case 14:var _je_=_aV_;break;
        default:var _je_=_a4_}
      return transform_int_alt(iconv,caml_format_int(_je_,n))}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _jd_=_a6_;break;
        case 2:var _jd_=_a7_;break;
        case 4:var _jd_=_a9_;break;
        case 5:var _jd_=_a__;break;
        case 6:var _jd_=_a$_;break;
        case 7:var _jd_=_ba_;break;
        case 8:var _jd_=_bb_;break;
        case 9:var _jd_=_bc_;break;
        case 10:var _jd_=_bd_;break;
        case 11:var _jd_=_be_;break;
        case 0:
        case 13:var _jd_=_a5_;break;
        case 3:
        case 14:var _jd_=_a8_;break;
        default:var _jd_=_bf_}
      return transform_int_alt(iconv,caml_format_int(_jd_,n))}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _jc_=_aG_;break;
        case 2:var _jc_=_aH_;break;
        case 4:var _jc_=_aJ_;break;
        case 5:var _jc_=_aK_;break;
        case 6:var _jc_=_aL_;break;
        case 7:var _jc_=_aM_;break;
        case 8:var _jc_=_aN_;break;
        case 9:var _jc_=_aO_;break;
        case 10:var _jc_=_aP_;break;
        case 11:var _jc_=_aQ_;break;
        case 0:
        case 13:var _jc_=_aF_;break;
        case 3:
        case 14:var _jc_=_aI_;break;
        default:var _jc_=_aR_}
      return transform_int_alt(iconv,caml_int64_format(_jc_,n))}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _i$_ >>> 0)
              {if(55 === _i$_)switch$0 = 1}
             else
              if(21 < _i$_ - 1 >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _ja_=1}
           var _jb_=_ja_?str:cat(str,_bg_);
           return caml_special_val(_jb_)}
        case 6:return hex(0);
        case 7:
         ...
         if(0 === l)
          ...
          {var r=caml_create_bytes(l),_i7_=l - 1 | 0,_i6_=0;
           if(! (_i7_ < 0))
            {var i=_i6_;
             for(;;)
              {var
                c=caml_bytes_unsafe_get(s,i),
                _i8_=25 < c - 97 >>> 0?c:c - 32 | 0;
               caml_bytes_unsafe_set(r,i,_i8_);
               var _i9_=i + 1 | 0;
               if(_i7_ !== i){var i=_i9_;continue}
               break}}
           var _i__=r}
         return caml_string_of_bytes(_i__);
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _i2_=pad$5[2],_i3_=pad$5[1];
               if(typeof prec$3 === "number")
                return prec$3
                        ?function(p,x)
                          {var str=fix_padding(_i3_,_i2_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)}
                        :function(x)
                          {var
                            str=convert_float(fconv,default_float_precision(fconv),x),
                            str$0=fix_padding(_i3_,_i2_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_i3_,_i2_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _i4_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(w,p,x)
                        {var str=fix_padding(_i4_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_i4_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_i4_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _i5_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _i5_[2] === "number")
              {var fmt=_i5_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_i1_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_i1_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _iY_=[8,acc,_bq_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_iY_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_iY_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_iX_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_iX_,rest])}
           ...
           return prec
                   ?function(p,x)
                     {var
                       str=
                        fix_padding
                         (_iV_,_iU_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(x)
                     {var str=fix_padding(_iV_,_iU_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=prec[1];
          return function(x)
           {var
             str=
              fix_padding
               (_iV_,_iU_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _iW_=pad[1];
        if(typeof prec === "number")
         return prec
                 ?function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_iW_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,x)
                   {var str=fix_padding(_iW_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=prec[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_iW_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_iP_=0;
      return make_printf(function(acc){output_acc(oc,acc);return 0},_iP_,fmt)}
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _by_;
      var _iN_=other_fields(x,i + 1 | 0),_iO_=field(x,i);
      return caml_call2(sprintf(_bz_),_iO_,_iN_)}
     ...
     {function conv(param)
      ...
      if(0 === caml_obj_tag(e))
       {var constructor=e[1][1],match=e.length - 1;
        if(2 < match >>> 0)
         var
          _iI_=other_fields(e,2),
          _iJ_=field(e,1),
          _iL_=caml_call2(sprintf(_bA_),_iJ_,_iI_);
        else
         switch(match)
          {case 0:var _iL_=_bB_;break;
           case 1:var _iL_=_bC_;break;
           default:var _iK_=field(e,1),_iL_=caml_call1(sprintf(_bD_),_iK_)}
        return cat(constructor,_iL_)}
      return e[1]}
         ...
         {var
          ...
          if(0 === slot[0])
           var
            ...
            _iy_=slot[4],
            _iz_=slot[3],
            _iA_=slot[6]?_bN_:_bP_,
            _iB_=slot[2],
            _iC_=slot[7],
            _iD_=info(slot[1]),
            match=
             [0,caml_call7(sprintf(_bO_),_iD_,_iC_,_iB_,_iA_,_iz_,_iy_,_ix_)];
          else
           if(slot[1])
            var match=0;
           else
            var _iE_=info(0),match=[0,caml_call1(sprintf(_bQ_),_iE_)];
    ...
    function default_uncaught_exception_han(exn,raw_backtrace)
     {var _iu_=to_string(exn);
      caml_call1(eprintf(_bT_),_iu_);
      print_raw_backtrace(stderr,raw_backtrace);
      var status=caml_ml_debug_info_status(0);
      if(status < 0)
       {var _iv_=abs(status);
        prerr_endline(caml_check_bound(errors,_iv_)[1 + _iv_])}
      return caml_ml_flush(stderr)}
     ...
     {try
       {try
         {var
          ...
          try {do_at_exit(0)}catch(_it_){}
          try
           {var
             _ip_=default_uncaught_exception_han(exn,raw_backtrace),
             _io_=_ip_}
          catch(exn$0)
           {exn$0 = caml_wrap_exception(exn$0);
            var
             ...
             _im_=to_string(exn);
            caml_call1(eprintf(_bV_),_im_);
            print_raw_backtrace(stderr,raw_backtrace);
            var _in_=to_string(exn$0);
            caml_call1(eprintf(_bW_),_in_);
            print_raw_backtrace(stderr,raw_backtrace$0);
            var _io_=caml_ml_flush(stderr)}
          var _iq_=_io_}
        catch(_is_)
         {_is_ = caml_wrap_exception(_is_);
          if(_is_ !== Out_of_memory)throw _is_;
          var _iq_=prerr_endline(_bU_)}
        return _iq_}
      catch(_ir_){return 0}}
    caml_register_named_value
        ...
        {var
         ...
         for(;;)
          {caml_check_bound(result[1],i$0)[1 + i$0] = i$0;
           var _ii_=i$0 + 1 | 0;
           if(54 !== i$0){var i$0=_ii_;continue}
           var accu=[0,_bX_],_ie_=54 + max$0(55,l) | 0,_id_=0;
           if(! (_ie_ < 0))
            {var i=_id_;
             for(;;)
              {var
               ...
               var
                _if_=accu[1],
                _h$_=caml_string_get(_if_,3) << 24,
                _ia_=caml_string_get(_if_,2) << 16,
                _ib_=caml_string_get(_if_,1) << 8,
                _ic_=
                 ((caml_string_get(_if_,0) + _ib_ | 0) + _ia_ | 0)
                 +
                 _h$_
                 |
                 0,
                _ig_=
                 (caml_check_bound(result[1],j)[1 + j] ^ _ic_)
                 &
                 1073741823;
               caml_check_bound(result[1],j)[1 + j] = _ig_;
               var _ih_=i + 1 | 0;
               if(_ie_ !== i){var i=_ih_;continue}
               break}}
           result[2] = 0;
           return result}}];
     ...
     {if(opt)var sth=opt[1],random=sth;else var random=randomized_default;
      ...
      for(;;)
       {if(! (initial_size <= x) && ! (max_array_length < (x * 2 | 0)))
        ...
        if(random)
         {var
           _h9_=caml_obj_tag(prng),
           _h__=250 === _h9_?prng[1]:246 === _h9_?force_lazy_block(prng):prng;
          _h__[2] = (_h__[2] + 1 | 0) % 55 | 0;
          var
           _h6_=_h__[2],
           curval=caml_check_bound(_h__[1],_h6_)[1 + _h6_],
           _h7_=(_h__[2] + 24 | 0) % 55 | 0,
           newval=
            caml_check_bound(_h__[1],_h7_)[1 + _h7_]
            +
           ...
           _h8_=_h__[2];
          caml_check_bound(_h__[1],_h8_)[1 + _h8_] = newval30;
          var seed=newval30}
        else
         var seed=0;
    ...
    function find$0(h,key)
     {var _h5_=indexfun(h,key),match=caml_check_bound(h[2],_h5_)[1 + _h5_];
      if(match)
    ...
    function public_method_label(s)
     {var accu=[0,0],_h2_=caml_ml_string_length(s) - 1 | 0,_h1_=0;
      if(! (_h2_ < 0))
       {var i=_h1_;
        for(;;)
         {var _h3_=caml_string_get(s,i);
          accu[1] = (223 * accu[1] | 0) + _h3_ | 0;
          var _h4_=i + 1 | 0;
          if(_h2_ !== i){var i=_h4_;continue}
          break}}
    ...
    function new_table(pub_labels)
     {table_count[1]++;
      ...
      var _hV_=((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
      caml_check_bound(methods,1)[2] = _hV_;
      var _hX_=len - 1 | 0,_hW_=0;
      if(! (_hX_ < 0))
       {var i=_hW_;
        for(;;)
         {var
           _hZ_=(i * 2 | 0) + 3 | 0,
           _hY_=caml_check_bound(pub_labels,i)[1 + i];
          caml_check_bound(methods,_hZ_)[1 + _hZ_] = _hY_;
          var _h0_=i + 1 | 0;
          if(_hX_ !== i){var i=_h0_;continue}
          break}}
      return [0,initial_object_size,methods,Meths[1],Labs[1],0,0,Vars[1],0]}
    function resize$0(array,new_size)
     {var len=array[2].length - 1,_hS_=len < new_size?1:0;
      if(_hS_)
       {var a2=caml_make_vect(new_size,dummy_met),_hT_=array[2],switch$0=0;
        if
         (0
          <=
          len
          &&
          !
          ((_hT_.length - 1 - len | 0) < 0)
          &&
          !
          ((a2.length - 1 - len | 0) < 0))
         {caml_array_blit(_hT_,0,a2,0,len);switch$0 = 1}
    ...
    function get_method_label(table,name)
     {try
       {var _hQ_=caml_call2(Meths[28],name,table[3]);return _hQ_}
      catch(_hR_)
    ...
    function new_cache(table)
     {var n=new_method(table),switch$0=0;
      ...
      return n$0}
    var t701=globalThis,t58=null,undefined$0=undefined;
    function test(x){return 1 - (x == t58?1:0)}
    function iter$1(x,f)
     {var _hN_=1 - (x == t58?1:0);return _hN_?caml_call1(f,x):_hN_}
    function case$0(x,f,g){return x == t58?caml_call1(f,0):caml_call1(g,x)}
    function test$0(x){return x !== undefined$0?1:0}
    function iter$2(x,f)
     {var _hM_=x !== undefined$0?1:0;return _hM_?caml_call1(f,x):_hM_}
    ...
    var
     ...
     t122=t701.Date,
     t252=t701.Math,
     Error=[248,_b2_,caml_fresh_oo_id(0)];
    register_exception(_b3_,[0,Error,{}]);
     ...
     {for(;;)
       {if(0 === type && 0 === name)return createElement(doc,elt);
        ...
        if(785140586 === _hD_)
         {try
           {var
             el=t818.createElement('<input name="x">'),
    ...
    function createCanvas(doc)
     {var t52=unsafeCreateElement(doc,_cc_);
      ...
      return t52}
    var html_element=t701.HTMLElement;
    html_element === undefined$0;
    function stopPropagation(ev)
     {function _hB_(param){return ev.stopPropagation()}
      function _hC_(param){return ev.cancelBubble = t11}
      return case$1(ev.stopPropagation,_hC_,_hB_)}
    var
      ...
      caml_js_pure_expr
       (function(param)
         {var
           l=
            [0,
             t701.requestAnimationFrame,
             [0,
              t701.mozRequestAnimationFrame,
              [0,
               t701.webkitRequestAnimationFrame,
               [0,
                t701.oRequestAnimationFrame,
                [0,t701.msRequestAnimationFrame,0]]]]];
          try
           {var
             req=find(function(c){return test$0(c)},l),
             _hz_=function(callback){return req(callback)};
            return _hz_}
          catch(_hA_)
    ...
    function urldecode_js_string_string(s$0)
     {t14.lastIndex = 0;
      ...
      return caml_string_of_jsbytes(t701.unescape(s))}
    caml_fresh_oo_id(0);
    function path_of_path_string(s)
     {var l=caml_ml_string_length(s);
      function aux(i)
       {try
         {var _hx_=index_from(s,i,47),j=_hx_}
        catch(_hy_)
      ...
      if(a && ! caml_string_notequal(a[1],_cg_))
       {var _hw_=a[2];
        if(! _hw_)return 0;
        if(! caml_string_notequal(_hw_[1],_ch_) && ! _hw_[2])return _ci_}
      return a}
              ...
              function(s)
               {function _hu_(param)
                 {var
                   y=param[2],
                   x=param[1],
                   _hv_=urldecode_js_string_string(y);
                  return [0,urldecode_js_string_string(x),_hv_]}
                var t2=caml_jsstring_of_string(make$0(1,61)),t5=s.indexOf(t2);
                if(t5 < 0)
                 var _ht_=undefined$0;
                else
                 var
                  t7=t5 + 1 | 0,
                  _hs_=s.slice(t7),
                  _ht_=[0,s.slice(0,t5),_hs_];
                return case$1(_ht_,interrupt,_hu_)},
             _hq_=aux([0,case$1(t18[idx$0],interrupt,_hp_),acc],_ho_);
            return _hq_}
          catch(_hr_)
           {_hr_ = caml_wrap_exception(_hr_);
            if(_hr_ === Local_exn)
    ...
    if(test$0(t701.location))
     var _cl_=t701.location;
    else
     var
      empty="",
      _dd_=[0,0,0,0],
      _de_=
       function
        ...
        {if(! _dd_[1])
          {if(0 === public_methods)
            var _gS_=new_table([0]);
           else
            {var
              tags=map(public_method_label,public_methods),
              table=new_table(tags),
              _gO_=public_methods.length - 1 - 1 | 0,
              _gN_=0;
             if(! (_gO_ < 0))
              {var i=_gN_;
               for(;;)
             ...
             var _gS_=table}
           var
            _gT_=new_variable(_gS_,_df_),
            _gQ_=map(function(_hn_){return get_method_label(_gS_,_hn_)},names),
            _gU_=_gQ_[1],
            _gV_=_gQ_[2],
            _gW_=_gQ_[3],
            _gX_=_gQ_[4],
            ...
            _g6_=
             function(self_1)
              {var env=self_1[1 + _gT_];return caml_call1(env[2],env[1])},
            _g7_=
             function(self_1)
              {var env=self_1[1 + _gT_];return caml_call1(env[3],env[1])},
            _g8_=
             function(self_1)
              {var env=self_1[1 + _gT_];return caml_call1(env[4],env[1])},
            _g9_=function(self_1){var env=self_1[1 + _gT_];return env[5]},
            _g__=function(self_1){var env=self_1[1 + _gT_];return env[6]},
            _g$_=function(self_1){var env=self_1[1 + _gT_];return env[7]},
            _ha_=function(self_1){var env=self_1[1 + _gT_];return env[8]},
            _hb_=function(self_1){var env=self_1[1 + _gT_];return env[9]},
            _hc_=function(self_1){var env=self_1[1 + _gT_];return env[10]},
            _hd_=function(self_1){var env=self_1[1 + _gT_];return env[11]},
            _he_=function(self_1){var env=self_1[1 + _gT_];return env[12]},
            methods=
             [0,
              _g1_,
              function(self_1){var env=self_1[1 + _gT_];return env[13]},
              _gX_,
              _he_,
              _g3_,
              _hd_,
           ...
           for(;;)
            {if(i$0[1] < len)
              {var
                _gR_=i$0[1],
                label=caml_check_bound(methods,_gR_)[1 + _gR_],
                next=
                 function(param)
                  {i$0[1]++;
                   var _hm_=i$0[1];
                   return caml_check_bound(methods,_hm_)[1 + _hm_]},
                clo=next(0);
                  ...
                  case 19:
                   var
                    ...
                    clo$0=
                     function(n,m)
                       {return function(obj)
                         {var _hk_=caml_call1(obj[1][1 + m],obj);
                          return caml_call2(obj[1][1 + n],obj,_hk_)}}
                      (n$15,m$1);
                   break;
                  case 20:
                  ...
                  case 22:
                   ...
                   var
                    clo$0=
                     function(m,e,n)
                       {return function(obj)
                         {var _hi_=obj[1 + e][1 + n];
                          return caml_call1(caml_get_public_method(_hi_,m,0),_hi_)}}
                      (m$4,e$4,n$17);
                   break;
                  default:
                   ...
                   var
                    clo$0=
                     function(m,n)
                       {return function(obj)
                         {var _hl_=caml_call1(obj[1][1 + n],obj);
                          return caml_call1(caml_get_public_method(_hl_,m,0),_hl_)}}
                      (m$5,n$18)}
               else
                var clo$0=clo;
               method_count[1]++;
               if(caml_call2(Labs[28],label,_gS_[4]))
                {resize$0(_gS_,label + 1 | 0);
                 caml_check_bound(_gS_[2],label)[1 + label] = clo$0}
               else
                _gS_[6] = [0,[0,label,clo$0],_gS_[6]];
               i$0[1]++;
               continue}
             var
              _hf_=
               function(_hh_)
                {var obj=caml_obj_block(248,_gS_[1]);
                 obj[1] = _gS_[2];
                 var _hg_=caml_set_oo_id(obj);
                 _hg_[1 + _gT_] = _hh_;
                 return _hg_};
             inst_var_count[1] = (inst_var_count[1] + _gS_[1] | 0) - 1 | 0;
             var l1=_gS_[8],l2=0;
             for(;;)
              {if(l1)
               ...
               resize$0
                (_gS_,
                 3 + ((caml_check_bound(_gS_[2],1)[2] * 16 | 0) / 32 | 0) | 0);
               _dd_[1] = _hf_;
               break}
             break}}
         return caml_call1
                 (_dd_[1],
                  [0,
                   ...
                   protocol,
                   href])},
      _dg_=function(param,_gM_){return 0},
      _dh_=function(param,_gL_){return 0},
    ...
    try
     ...
     {_gK_ = caml_wrap_exception(_gK_);if(_gK_[1] !== Failure)throw _gK_}
    ...
    var t713=caml_js_get_console(0);
    caml_fresh_oo_id(0);
     ...
     {var _gJ_=p[1];
      switch(_gJ_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_gJ_[1],p$1=underlying(p$0);
    ...
    function add_implicitly_removed_callbac(callbacks,f)
     {var
       node$0=[1,f],
       _gI_=callbacks[1],
       node=typeof _gI_ === "number"?node$0:[0,node$0,_gI_];
      callbacks[1] = node;
      return 0}
    var
    ...
    function handle_with_async_exception_ho(f,v)
     {try
       {var _gH_=caml_call1(f,v);return _gH_}
      catch(exn)
    ...
    function run_callbacks(callbacks,result)
     {if(1 === result[0])
       var _gF_=result[1] === Canceled?1:0,is_canceled=_gF_;
      else
       var is_canceled=0;
      if(is_canceled)
       {var
        ...
        iter_callback_list(_gD_,0)}
      var _gE_=callbacks[1];
      ...
      return iter_callback_list$0(_gE_,0)}
    var
        ...
        {if(0 !== q[1])
          {var _gB_=q[2];
           if(_gB_)
            {var _gC_=_gB_[1];
             if(_gB_[2])
              {var next=_gB_[2];q[1] = q[1] - 1 | 0;q[2] = next}
             else
              {q[1] = 0;q[2] = 0;q[3] = 0}
             var result=_gC_[2],callbacks=_gC_[1];
    ...
    function wakeup_general(api_function_name,p,result)
     {var p$0=underlying(p),_gA_=p$0[1];
      switch(_gA_[0])
       {case 1:
         return _gA_[1] === Canceled
                 ?0
      ...
      switch(_gz_[0])
       {case 1:return resolve(_cv_,0,outer_promise,p[1]);
        case 2:
         ...
         var
          _gx_=p_callbacks[2],
          _gy_=outer_callbacks[2],
          cancel_callbacks=
           typeof _gy_ === "number"
            ?_gx_
            :typeof _gx_ === "number"?_gy_:[0,_gy_,_gx_];
       ...
       {var p=new_pending([0,p$0]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
          ...
          try
           {var _gw_=caml_call1(f,v),p$0=_gw_}
       ...
       {case 1:return [0,_gu_];
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_cx_,function(param){return caml_call1(f,v)},_gv_)}}
    function on_cancel(p,f)
     {var p$0=underlying(p),_gs_=p$0[1];
      switch(_gs_[0])
       {case 1:
         if(_gs_[1] === Canceled)
          {var
    ...
    function poll(p)
     {var _gr_=underlying(p)[1];
      switch(_gr_[0])
       {case 1:var e=_gr_[1];throw e;
        case 2:return 0;
        default:var v=_gr_[1];return [0,v]}}
    var pause_hook=[0,function(_gq_){return 0}],s1=create$1(0),_cA_=[0,0];
    ...
    function yield$0(param)
     {var match=task(0),w=match[2],t=match[1],d=0.;
      function callback(_go_){return wakeup(w,_go_)}
      var id=[0,0];
      function loop(step,param)
       {if(2147483000. < step)
        ...
        var
         cb=remain == 0.?callback:function(_gn_){return loop(remain,_gn_)},
         t131=caml_js_wrap_callback(cb);
        id[1] = [0,t701.setTimeout(t131,step$0)];
        return 0}
      loop(d,0);
      on_cancel
       (t,
        function(param)
         {var _gm_=id[1];
          if(_gm_){var x=_gm_[1];id[1] = 0;return t701.clearTimeout(x)}
          return 0});
      return t}
    function wakeup$0(param)
     {if(1 === param)
       {var t0=caml_js_wrap_callback(wakeup_paused);
        t701.setTimeout(t0,0.);
        return 0}
      return 0}
    register_pause_notifier(wakeup$0);
    function prerr_string$0(s)
     {var t3=caml_jsstring_of_string(s);return t713.log(t3)}
    ...
    var t279=option(t701.hyp_style);
    ...
    function transf(a,b,c,d,z)
     {var _gl_=add_mul(c,z,d);return div(add_mul(a,z,b),_gl_)}
    function transl(p)
     {var c=mul(conj(p),t);return function(z){return transf(t,p,c,t,z)}}
    function compose(param,_gj_)
     {var
       t2=_gj_[2],
       p2=_gj_[1],
       t1=param[2],
       ...
       _gk_=div(conj(den),den),
       c=mul(mul(t1,t2),_gk_),
       _gi_=sdiv(c,norm(c));
      return [0,div(add$0(t2p1,p2),den),_gi_]}
    function compute_translation(z0,z1)
     {var dz=sub$1(z1,z0),z0z1=mul(z0,z1),_gh_=1. - sq_norm(z0z1);
      return sdiv(add$0(mul(z0z1,conj(dz)),dz),_gh_)}
    var t278=JSON;
     ...
     {function _f$_(r)
      ...
      iter
       (function(param)
        ...
        sth);
      function headers(s)
       {function _gf_(v){return [0,caml_string_of_jsstring(v)]}
        var t35=caml_jsbytes_of_string(s);
        function _gg_(param){return 0}
        return case$0(t26.getResponseHeader(t35),_gg_,_gf_)}
      var st=[0,382334108];
                  ...
                  _ga_=
                   function(param)
                    {var x=t26.responseXML;
                     ...
                     var match=case$0(x,function(param){return 0},_ge_);
                     if(match)
                      {var doc=match[1];
                       return doc.documentElement === t58?0:[0,doc]}
                     return 0},
                  _gb_=function(x){return caml_string_of_jsstring(x)},
                  _gc_=function(param){return _cC_},
                  response=
                   [0,url,code,headers,case$0(t26.responseText,_gc_,_gb_),_ga_];
                 return wakeup(w,response)}
               return _gd_
              }
            return 0});
      t26.onreadystatechange = t47;
      function _f__(t57){return 0}
      iter$2(t26.upload,_f__);
      t26.send(t58);
      on_cancel(res,function(param){return t26.abort()});
      return symbol_bind(res,_f$_)}
    function getfile(f)
     {try
       {var _f8_=return$0(caml_read_file_content(f));return _f8_}
      catch(_f9_)
       {_f9_ = caml_wrap_exception(_f9_);
        if(_f9_ === Not_found)return http_get(f);
        throw _f9_}}
    function load_image(t4)
     {var t5=createImg(t818);
      function _f7_(param){return return$0(t5)}
      var
       match=task(0),
       w=match[2],
       t=match[1],
      ...
      t5.onload = t2;
      t5.src = t4;
      return symbol_bind(t,_f7_)}
    function create_canvas(w,h)
     {var d=t701.document,t10=createCanvas(d);
      t10.width = w;
      t10.height = h;
      return t10}
    var debug_widget=createDiv(t818);
    ...
    var
     text_size_div=
      [246,
       function(_f6_)
        {var t112=createDiv(t818),t108=t112.style;
         t108.visibility = "hidden";
         var t111=t112.style;
         t111.position = "absolute";
         var t114=t112.style;
         t114.whiteSpace = "nowrap";
         appendChild(t818.body,t112);
         return t112}];
    function f(param)
     {function _f4_(param)
       {function _f5_(param){return "en"}
        var t126=t701.navigator;
        return get(t126.userLanguage,_f5_)}
      var t124=t701.navigator,t129=get(t124.language,_f4_);
      return t129.substring(0,2)}
    function _cF_(st){var x=st.getItem("hyp_lang");return x == t58?f(0):x}
    var language=[0,case$1(t701.localStorage,f,_cF_)];
    t713.log(language[1]);
    function load_messages(param)
     {function _f3_(s)
       {var t139=caml_jsstring_of_string(s);return return$0(t278.parse(t139))}
      return symbol_bind(getfile(_cG_),_f3_)}
    function local_messages(msgs){return option(msgs[language[1]])}
    function screen_transform(canvas)
     {var
       _f2_=opt_style(t279.padding,0.),
       offset=opt_style(t279.border,0.5) + _f2_,
       w=canvas.width,
       h=canvas.height,
       rx=w / 2.,
       ry=h / 2.,
    ...
    function tree_vertice_count(n)
     {var l=n[2],_f1_=1;
      return fold_left
              (function(s,n){return s + tree_vertice_count(n) | 0},_f1_,l)}
    ...
    function randomize_tree(n)
     {var ch=n[2],_fX_=ch.length - 1 - 1 | 0;
      if(! (_fX_ < 0))
       {var i=_fX_;
        for(;;)
         {var
           ...
           _fY_=caml_check_bound(ch,j)[1 + j];
          caml_check_bound(ch,i)[1 + i] = _fY_;
          caml_check_bound(ch,j)[1 + j] = v;
          var _fZ_=i - 1 | 0;
          if(0 !== i){var i=_fZ_;continue}
          break}}
              ...
              ?(need_redraw[1]
                ...
                caml_call1
                 (requestAnimationFrame,
                  caml_js_wrap_callback
                   (function(param)
                     {var _fW_=need_redraw[1];return _fW_?perform_redraw(0):_fW_})))
              :_fV_}
    function compute_text_node(info)
     {var
       t260=opt_style(t279.nodeFont,"20px sans-serif"),
       _fU_=caml_obj_tag(text_size_div),
       d=
        250 === _fU_
         ?text_size_div[1]
         :246 === _fU_?force_lazy_block(text_size_div):text_size_div,
       t118=d.style;
      t118.font = t260;
      var t119=caml_jsstring_of_string(info),txt=t818.createTextNode(t119);
      appendChild(d,txt);
      ...
      var
       w$0=w + 8 | 0,
       h$0=h + 8 | 0,
       t255=create_canvas(w$0,h$0),
       t272=t255.getContext("2d"),
       t257=opt_style(t279.nodeBackgroundColor,tree_color);
      t272.fillStyle = t257;
      ...
      t272.arcTo(t82,0.,t84,t85,t104);
      var t91=0. + h$0,t90=0. + w$0 - t104,t89=0. + h$0,t88=0. + w$0;
      t272.arcTo(t88,t89,t90,t91,t104);
      var t97=0. + h$0 - t104,t95=0. + h$0;
      t272.arcTo(0.,t95,0.,t97,t104);
      var t102=0. + t104;
      t272.arcTo(0.,0.,t102,0.,t104);
      t272.fill();
      t272.font = t260;
      var t263=opt_style(t279.nodeColor,"black");
      t272.fillStyle = t263;
      t272.textAlign = "center";
      t272.textBaseline = "middle";
      var t271=h$0 / 2.,t270=w$0 / 2.,t269=caml_jsstring_of_string(info);
      t272.fillText(t269,t270,t271);
      return t255}
    function compute_text_nodes(node_names,nodes)
     {try
       {var _fO_=assq(language[1],node_names)[1],names=_fO_}
      catch(_fS_)
       {_fS_ = caml_wrap_exception(_fS_);
        if(_fS_ !== Not_found)throw _fS_;
        try
         {var _fN_=assq("en",node_names)[1],_fF_=_fN_}
        catch(_fT_)
        ...
        var names=_fF_}
      try
       {var _fM_=find$0(names,_cK_),_fG_=_fM_}
      catch(_fR_)
       {_fR_ = caml_wrap_exception(_fR_);
        if(_fR_ !== Not_found)throw _fR_;
        var _fG_=_cJ_}
      t818.title = caml_jsstring_of_string(_fG_);
      var _fI_=nodes.length - 1 - 1 | 0,_fH_=0;
      if(! (_fI_ < 0))
       {var i=_fH_;
        for(;;)
         {var match=caml_check_bound(nodes,i)[1 + i],_fJ_=match[2],switch$0=0;
          if(typeof _fJ_ !== "number" && 4204112 === _fJ_[1])
           {var
             match$0=_fJ_[2],
             info=match$0[3],
             is_root=match$0[1],
             neigh=match[1];
            try
             {var _fL_=[0,compute_text_node(find$0(names,info))],canvas=_fL_}
            catch(_fQ_)
             {_fQ_ = caml_wrap_exception(_fQ_);
              if(_fQ_ !== Not_found)throw _fQ_;
              var canvas=0,_fP_=_fQ_}
    ...
    function load_tree(param)
     {function _eU_(s)
       {var
         t275=caml_jsstring_of_string(s),
         info$0=t278.parse(t275),
         node_names=info$0[2],
         tree$0=info$0[1];
             ...
             {var
              ...
              if(_fD_)
               {var
                 ...
                 nsize$0=osize * 2 | 0,
                 _fC_=nsize$0 < max_array_length?1:0;
                if(_fC_)
                 {var
                   ndata=caml_make_vect(nsize$0,0),
                   _ft_=h.length - 1 < 4?1:0,
                   _fu_=_ft_ || (h[4] < 0?1:0),
                   inplace=1 - _fu_;
                  h[2] = ndata;
                  var
                      ...
                      for(;;)
                       {if(cell)
                         {var
                          ...
                          continue}
                        var _fB_=i$0 + 1 | 0;
                        if(_fw_ !== i$0){var i$0=_fB_;continue a}
                        break}
                      break}}
                  if(inplace)
        ...
        var
         node_names$0=
          symbol
           (symbol(node_names,function(_fs_){return map(_eZ_,_fs_)}),to_list);
              ...
              [0,
               ...
               [0,
                [246,
                 function(_fp_)
                  {function _fq_(param)
                    {function _fr_(img){schedule_redraw(0);return return$0(img)}
                     return symbol_bind
                             (load_image
                               (caml_jsstring_of_string(cat(_cI_,cat(img,_cH_)))),
                              _fr_)}
                   return symbol_bind(yield$0(0),_fq_)}],
                img]];
           else
        ...
        function layout_rec
         ...
         {var
          ...
          vi[1]++;
          var _fm_=transf[1];
          caml_check_bound(vertices,i$0)[1 + i$0] = _fm_;
          var l$0=ch.length - 1;
          if(0 === l$0)
           var ch$0=[0];
          else
           {var j=[0,0],total_weight=weight_sum(ch_weights);
            ...
            if(0 === l)
             ...
             {var
               _fg_=caml_check_bound(ch_weights,0)[1],
               r=caml_make_vect(l,f(caml_check_bound(ch,0)[1],_fg_)),
               _fi_=l - 1 | 0,
               _fh_=1;
              if(! (_fi_ < 1))
               {var i=_fh_;
                for(;;)
                 {var
                   _fj_=caml_check_bound(ch_weights,i)[1 + i],
                   _fk_=f(caml_check_bound(ch,i)[1 + i],_fj_);
                  caml_check_bound(r,i)[1 + i] = _fk_;
                  var _fl_=i + 1 | 0;
                  if(_fi_ !== i){var i=_fl_;continue}
                  break}}
              var _fo_=r}
            var ch$0=_fo_}
        ...
        function compute_frontiers(node)
         {var l=node[2],i=node[1];
          ...
          if(0 === l.length - 1)
           var _fa_=[0,status(i)],_fb_=[0,[0,status(i)],_fa_];
          else
           var
            _fc_=l.length - 1 - 1 | 0,
            _fd_=caml_check_bound(l,_fc_)[1 + _fc_][1],
            _fe_=caml_check_bound(frontiers,_fd_)[1 + _fd_][2],
            _ff_=caml_check_bound(l,0)[1][1],
            _fb_=[0,caml_check_bound(frontiers,_ff_)[1 + _ff_][1],_fe_];
          caml_check_bound(frontiers,i)[1 + i] = _fb_;
          return 0}
        ...
        function compute_neigh(node,parent,lft,rght)
         {var
           ...
           _e0_=caml_array_concat([0,parent,[0,lft,[0,rght,[0,children,0]]]]);
          caml_check_bound(neighboors,i)[1 + i] = _e0_;
          var
           ...
           {var j=_e1_;
            for(;;)
             {if(0 < j)
               var
                _e3_=j - 1 | 0,
                _e4_=caml_check_bound(ch,_e3_)[1 + _e3_][1],
                lft$0=caml_check_bound(frontiers,_e4_)[1 + _e4_][2];
              else
               if(is_root)
                var
                 _e__=n - 1 | 0,
                 _e$_=caml_check_bound(ch,_e__)[1 + _e__][1],
                 lft$0=caml_check_bound(frontiers,_e$_)[1 + _e$_][2];
               else
                var lft$0=lft;
              if(j < (n - 1 | 0))
               var
                _e5_=j + 1 | 0,
                _e6_=caml_check_bound(ch,_e5_)[1 + _e5_][1],
                rght$0=caml_check_bound(frontiers,_e6_)[1 + _e6_][1];
              else
               if(is_root)
                var
                 _e9_=caml_check_bound(ch,0)[1][1],
                 rght$0=caml_check_bound(frontiers,_e9_)[1 + _e9_][1];
               else
                var rght$0=rght;
              var _e7_=[0,status(i)];
              compute_neigh(caml_check_bound(ch,j)[1 + j],_e7_,lft$0,rght$0);
              var _e8_=j + 1 | 0;
              if(_e2_ !== j){var j=_e8_;continue}
              break}}
          return 0}
        compute_neigh(tree,[0],[0],[0]);
        var _eW_=nodes.length - 1 - 1 | 0,_eV_=0;
        if(! (_eW_ < 0))
         {var i=_eV_;
          for(;;)
           {var
             ...
             info=match[2],
             _eX_=[0,caml_check_bound(neighboors,i)[1 + i],info];
            caml_check_bound(nodes,i)[1 + i] = _eX_;
            var _eY_=i + 1 | 0;
      ...
      return symbol_bind(getfile(tree_url),_eU_)}
    function load_image_info(param)
     {function _eT_(s)
       {var t277=caml_jsstring_of_string(s);return return$0(t278.parse(t277))}
      return symbol_bind(getfile(_cO_),_eT_)}
    function close_button(over)
     {var
       t289=opt_style(t279.buttonColor,"#888888"),
       t314=create_canvas(32,32),
       t305=t314.getContext("2d");
      t305.save();
      t305.lineWidth = 2.;
      t305.strokeStyle = t289;
      if(over){t305.shadowBlur = 4.;t305.shadowColor = t289}
      t305.beginPath();
      t305.moveTo(6.82842712474619,6.82842712474619);
      t305.lineTo(25.1715728752538084,25.1715728752538084);
      t305.moveTo(6.82842712474619,25.1715728752538084);
      t305.lineTo(25.1715728752538084,6.82842712474619);
      t305.stroke();
      t305.restore();
      var _eS_=over?_cP_:_cQ_,t306=caml_jsstring_of_string(_eS_);
      t314.className = t306;
      var t310=t314.style;
      t310.position = "absolute";
      var t313=t314.style;
      t313.top = "0";
      var t316=t314.style;
      t316.right = "0";
    ...
    function img_button(href,h,src)
     {function decoration(over)
       {var t318=createImg(t818),t317=icon(src);
        t318.src = t317;
        var t338=createDiv(t818),t321=t338.style;
        t321.position = "absolute";
        var t324=t338.style;
        t324.width = "38px";
        var
         t326=
        ...
        var
         ...
         t336=t338.style;
        t336.padding = t335;
        var _eR_=over?_cU_:_cW_,t337=caml_jsstring_of_string(cat(_cV_,_eR_));
        t338.className = t337;
        appendChild(t338,t318);
        return t338}
      var t344=createDiv(t818);
      t344.className = "button";
      var t343=t344.style;
      t343.width = "48px";
      var
       t345=
      ...
      t346.height = t345;
      if(href)
       {var url=href[1],t350=createA(t818);
        t350.target = "_blank";
        t350.href = url;
        appendChild(t344,t350);
        var container=t350}
      else
       var container=t344;
    ...
    function tooltip(txt)
     {var t357=createDiv(t818),t353=t357.style;
      t353.position = "absolute";
      t357.className = "tooltip on";
      t357.innerHTML = txt;
      return t357}
    function show_on_click(t363,txt)
     {var
       activated=[0,0],
       t362=
        handler
                 ...
                 (function(ev)
                   {function _eQ_(param)
                     {iter$1(c[1],removeEventListener);
                      ...
                      activated[1] = 0;
                      return return$0(0)}
                    symbol_bind(yield$0(0),_eQ_);
                    return t11}),
                t11);
              txt.className = "text"}
            stopPropagation(ev);
            return t238});
      return t363.onclick = t362}
    function show_image(all_messages,image_info,name,small_image)
     {return symbol_bind
              (image_info,
               function(image_info)
                {var
                  t567=local_messages(all_messages),
                  i=[0,-1],
                  name_js=caml_jsstring_of_string(name),
                  _eE_=image_info.length - 1 - 1 | 0,
                  _eD_=0;
                 if(! (_eE_ < 0))
                  {var j=_eD_;
                   for(;;)
                    {if(name_js === caml_check_bound(image_info,j)[1 + j][1])
                      i[1] = j;
                     var _eK_=j + 1 | 0;
                     if(_eE_ !== j){var j=_eK_;continue}
                     break}}
                 if(0 <= i[1])
                  {var
                    _eF_=i[1],
                    info=caml_check_bound(image_info,_eF_)[1 + _eF_];
                   t713.log(name,i[1]);
                   var t382=createDiv(t818),t369=t382.style;
                   t369.margin = "10px";
                   var t372=t382.style;
                   t372.position = "absolute";
                   var t375=t382.style;
                   t375.top = "0";
                   var t378=t382.style;
                   t378.bottom = "0";
                   ...
                   var t384=t382.style;
                   t384.right = "0";
                   var t397=createDiv(t818),t387=t397.style;
                   t387.position = "absolute";
                   var t390=t397.style;
                   t390.top = "0";
                   var t393=t397.style;
                   t393.bottom = "4em";
                   ...
                   var
                    wrap=
                     function(elt)
                      {var t418=createDiv(t818),t402=t418.style;
                       t402.position = "absolute";
                       var t405=t418.style;
                       t405.top = "0";
                       var t408=t418.style;
                       t408.bottom = "0";
                       ...
                       var
                        ...
                        t420=t418.style;
                       t420.maxHeight = t419;
                       appendChild(t418,elt);
                       return t418},
                    t482=createImg(t818),
                    _eG_=caml_obj_tag(small_image),
                    _eH_=
                     250 === _eG_
                      ?small_image[1]
                      :246 === _eG_?force_lazy_block(small_image):small_image,
                    match=poll(_eH_);
                   if(match)
                    {var
                      small_image$0=match[1],
                      t447=create_canvas(info[4],info[5]),
                      t428=t447.getContext("2d");
                     t428.drawImage(small_image$0,0.,0.,info[4],info[5]);
                     var t431=t447.style;
                     t431.display = "block";
                     var t434=t447.style;
                     t434.height = "auto";
                     ...
                     t443.maxHeight = "100%";
                     var t446=t447.style;
                     t446.marginLeft = "auto";
                     var t449=t447.style;
                     t449.marginRight = "auto";
                     var w=wrap(t447);
                     appendChild(t397,w);
                     var
                      t450=
                       handler(function(param){removeChild(t397,w);return t238});
                     t482.onload = t450}
                   var _eI_=info[7];
                   if(_eI_)
                    var url=_eI_[1],url$0=url;
                   else
                   ...
                   t472.maxHeight = "100%";
                   var t475=t482.style;
                   t475.marginLeft = "auto";
                   var t478=t482.style;
                   t478.marginRight = "auto";
                   var
                    w$0=wrap(t482),
                    handle_error=
                     function(param){removeChild(t397,w$0);return t238},
                    t479=handler(handle_error);
                   t482.onerror = t479;
                   var t481=handler(handle_error);
                   t482.onabort = t481;
                   appendChild(t397,w$0);
                   appendChild(t382,t397);
                   var t498=createDiv(t818);
                   t498.innerHTML = info[3];
                   var
                    t485=
                   ...
                   t498.className = "text";
                   var t491=t498.style;
                   t491.position = "absolute";
                   var t494=t498.style;
                   t494.bottom = "0";
                   var t497=t498.style;
                   t497.marginRight = "auto";
                   var t500=t498.style;
                   t500.marginLeft = "auto";
                   appendChild(t382,t498);
                   var t591=createDiv(t818);
                   appendChild(t591,t382);
                   t591.className = "overlay";
                   var t505=t591.style;
                   t505.width = "100%";
                   var t508=t591.style;
                   t508.height = "100%";
                   var t511=t591.style;
                   t511.position = "absolute";
                   var t514=t591.style;
                   t514.top = "0";
                   var t517=t591.style;
                   t517.left = "0";
                   var t520=t591.style;
                   t520.zIndex = "1";
                   var t532=createDiv(t818);
                   t532.className = "button";
                   var t525=t532.style;
                   t525.position = "absolute";
                   var t528=t532.style;
                   t528.top = "0";
                   var t531=t532.style;
                   t531.right = "0";
                   var t534=t532.style;
                   t534.cursor = "pointer";
                   appendChild(t532,close_button(1));
                   appendChild(t532,close_button(0));
                   var
                    t539=
                     tooltip
                      (opt_style
                        (t567.close,"Click anywhere to return to the tree")),
                    t538=t539.style;
                   t538.right = "32px";
                   var t541=t539.style;
                   t541.top = "20px";
                   appendChild(t532,t539);
                   appendChild(t591,t532);
                   var t587=createDiv(t818),t544=t587.style;
                   t544.position = "absolute";
                   var t547=t587.style;
                   t547.top = "0";
                   var t550=t587.style;
                   t550.left = "0";
                   var
                    ...
                    t555=
                     tooltip
                      (opt_style
                        (t567.wikimediaCommons,
                         "See image description on Wikimedia Commons")),
                    t554=t555.style;
                   t554.left = "48px";
                   var t557=t555.style;
                   t557.top = "12px";
                   appendChild(commons,t555);
                   appendChild(t587,commons);
                   var
                    ...
                    list=
                     function(title,lang)
                      {var ul=createUl(t818),empty=[0,1],_eL_=info[6];
                       iter$0
                        (function(param)
                          {var
                            refer=param[3],
                            lang$0=param[2],
                            name=param[1],
                            _eN_=lang$0 === lang?1:0;
                           if(_eN_)
                            {empty[1] = 0;
                             var t563=createA(t818);
                             appendChild(t563,t818.createTextNode(name));
                             t563.target = "_blank";
                             var
                              ...
                              _eO_=
                               0 === caml_ml_string_length(refer$0)
                                ...
                                :refer$0,
                              _eP_=cat(_c3_,_eO_),
                              url=cat(_c4_,cat(caml_string_of_jsstring(lang),_eP_)),
                              t562=caml_jsstring_of_string(url);
                             t563.href = t562;
                             var li=createLi(t818);
                             appendChild(li,t563);
                       ...
                       if(_eM_)
                        {count[1]++;
                         var dd=createDd(t818);
                         appendChild(dd,t818.createTextNode(title));
                         appendChild(dl,dd);
                         var dt=createDt(t818);
                         appendChild(dt,ul);
                         return appendChild(dl,dt)}
                       return _eM_},
                    _eJ_=language[1];
                   list(opt_style(t567.language,"In English"),_eJ_);
                   if(language[1] !== "en")list("In English","en");
                   if(0 < count[1])
                    appendChild(t585,dl);
                   else
                    {var t568=opt_style(t567.noRef,"No reference found.");
                     appendChild(t585,t818.createTextNode(t568))}
                   t585.className = "text on";
                   var t574=t585.style;
                   t574.position = "absolute";
                   var t577=t585.style;
                   t577.left = "48px";
                   var t580=t585.style;
                   t580.top = "62px";
                   var t583=t585.style;
                   t583.whiteSpace = "nowrap";
                   appendChild(wikipedia,t585);
                   appendChild(t587,wikipedia);
                   var
                    t584=
                     handler(function(ev){stopPropagation(ev);return t11});
                   t585.onclick = t584;
                   show_on_click(wikipedia,t585);
                   var
                    t586=
                     handler(function(ev){stopPropagation(ev);return t11});
                   t587.onclick = t586;
                   appendChild(t591,t587);
                   appendChild(t818.body,t591);
                   var
                    t590=
                     handler
                      (function(param){removeChild(t818.body,t591);return t11});
                   t591.onclick = t590}
                 return return$0(0)})}
    var information_en=caml_jsstring_of_string(_c8_);
    function show_information_page(messages,tree_i18n)
     {try
       {var _eA_=assq(language[1],tree_i18n)[2],info=_eA_}
      catch(_eB_)
       {_eB_ = caml_wrap_exception(_eB_);
        if(_eB_ !== Not_found)throw _eB_;
        try
         {var _ez_=assq("en",tree_i18n)[2],_ey_=_ez_}
        catch(_eC_)
         {_eC_ = caml_wrap_exception(_eC_);
          if(_eC_ !== Not_found)throw _eC_;
          var _ey_=information_en}
        var info=_ey_}
      var txt=createDiv(t818);
      txt.className = "text";
      txt.style.width = "80%";
      txt.style.margin = "auto";
      txt.innerHTML = info;
      var cell=createDiv(t818);
      cell.style.display = "table-cell";
      cell.style.verticalAlign = "middle";
      appendChild(cell,txt);
      var table=createDiv(t818);
      table.style.width = "100%";
      table.style.height = "100%";
      table.style.display = "table";
      appendChild(table,cell);
      var overlay=createDiv(t818);
      overlay.className = "overlay translucent";
      appendChild(overlay,table);
      var c=[0,t58];
      function close_info(param)
       {removeChild(t818.body,overlay);
    ...
    function unsupported_messages(param)
     {var t642=createDiv(t818);
      ...
      var t646=createDiv(t818),t645=t646.style;
      t645.display = "table-cell";
      var t648=t646.style;
      t648.verticalAlign = "middle";
      appendChild(t646,t642);
      var t655=createDiv(t818),t651=t655.style;
      t651.width = "100%";
      var t654=t655.style;
      t654.height = "100%";
      var t657=t655.style;
      t657.display = "table";
      appendChild(t655,t646);
      var t659=createDiv(t818);
      t659.className = "overlay";
      appendChild(t659,t655);
      return appendChild(t818.body,t659)}
            ...
            return symbol_bind
                    (all_messages,
                     function(all_messages)
                      {var t686=t818.documentElement,t664=t686.style;
                       t664.overflow = "hidden";
                       var t667=t686.style;
                       t667.height = "100%";
                       var t669=t818.body,t671=t669.style;
                       t671.overflow = "hidden";
                       var t673=t818.body,t675=t673.style;
                       t675.margin = "0px";
                       var t677=t818.body,t679=t677.style;
                       t679.height = "100%";
                       var
                        w=t686.clientWidth,
                        h=t686.clientHeight,
                        t711=create_canvas(w,h);
                       appendChild(t818.body,t711);
                       var
                        tr=[0,[0,zero,t]],
                        tr$0=[0,tr[1]],
                        l=vertices.length - 1,
                       ...
                       function(param)
                        {need_redraw[1] = 0;
                         t713.time("transform");
                         var
                          t689=t686.clientWidth,
                          t691=t686.clientHeight,
                          _eq_=t689 !== t711.width?1:0,
                          _er_=_eq_ || (t691 !== t711.height?1:0);
                         if(_er_){t711.width = t689;t711.height = t691}
                         var
                          _es_=tr$0[1],
                          t$0=_es_[2],
                          p=_es_[1],
                          ...
                          {var i=_d6_;
                           for(;;)
                            {var
                             ...
                             break}}
                         t713.timeEnd("transform");
                         t713.time("draw");
                         var
                          t208=t711.getContext("2d"),
                          transf$0=screen_transform(t711),
                          dy$1=transf$0[4],
                          dx$1=transf$0[3],
                          ry$1=transf$0[2],
                          rx$1=transf$0[1],
                         ...
                         var padding=opt_style(t279.padding,0.);
                         t208.beginPath();
                         ellipse_arc
                          (t208,dx$1,dy$1,rx$1 + padding,ry$1 + padding,0.,7.,t238);
                         function _d__(color)
                          {t208.fillStyle = color;return t208.fill()}
                         iter$2(t279.backgroundColor,_d__);
                         function _d$_(color)
                          {t208.lineWidth = 1.;
                           t208.strokeStyle = color;
                           return t208.stroke()}
                         iter$2(t279.boundaryColor,_d$_);
                         t208.lineWidth = 2.;
                         t208.lineCap = "round";
                         var t205=opt_style(t279.treeColor,tree_color);
                         t208.strokeStyle = t205;
                         var
                          ry$2=transf$0[2],
                          rx$2=transf$0[1],
                          _eb_=edges.length - 1 - 1 | 0,
                          _ea_=0;
                         if(! (_eb_ < 0))
                          {var i$1=_ea_;
                           for(;;)
                              ...
                              {t208.lineWidth = w$3;
                               ...
                               if(Math.abs(d) < 0.05)
                                ...
                                {var
                                 ...
                                 t208.stroke()}}
                             var _ep_=i$1 + 1 | 0;
                             if(_eb_ !== i$1){var i$1=_ep_;continue}
                             break}}
                         var
                          image_count=[0,0],
                          large_image_count=[0,0],
                          _ed_=nodes.length - 1 - 1 | 0,
                          _ec_=0;
                         if(! (_ed_ < 0))
                          {var i$0=_ec_;
                           for(;;)
                               ...
                               if(4204112 <= img[1])
                                {var _ef_=img[2],_eg_=_ef_[2];
                                 if(_eg_)
                                  {var
                                   ...
                                   if(circle)
                                    {t208.beginPath();
                                     var t231=opt_style(t279.nodeBackgroundColor,tree_color);
                                     t208.fillStyle = t231;
                                     var
                                ...
                                {var match$0=img[2],img$0=match$0[1];
                                  ...
                                  min_scale$0=
                                   function(z)
                                    {function min_scale(l,w,h,s)
                                      {var s$0=[0,s],_eu_=l.length - 1 - 1 | 0,_et_=0;
                                       if(! (_eu_ < 0))
                                        {var i=_et_;
                                         for(;;)
                                          {var
                                            ...
                                            _ev_=z[1],
                                            sx=
                                             Math.abs(caml_check_bound(vertices$0,j)[1 + j][1] - _ev_)
                                             /
                                             w,
                                            _ew_=z[2],
                                            sy=
                                             Math.abs(caml_check_bound(vertices$0,j)[1 + j][2] - _ew_)
                                             /
                                             h,
                                            s$1=sy < sx?sx:sy,
                                 ...
                                 if(caml_obj_tag(img$0) !== 246)
                                  {var
                                    _ei_=caml_obj_tag(img$0),
                                    _ej_=
                                     250 === _ei_
                                      ?img$0[1]
                                      :246 === _ei_?force_lazy_block(img$0):img$0,
                                    match$1=poll(_ej_);
                                   if(match$1)
                                    {var
                                      img$1=match$1[1],
                                     ...
                                     if(_el_)
                                      {var
                                       ...
                                       image_count[1]++;
                                       var _em_=2. <= w$2?1:0,_en_=_em_?2. <= h$2?1:0:_em_;
                                       if(_en_)large_image_count[1]++}}}
                                 else
                                  {var s$0=min_scale(l,1.,1.,1.);
                                   if(1. < s$0 * max(rx$2,ry$2))
                                    {var _eo_=caml_obj_tag(img$0);
                                     if(250 !== _eo_ && 246 === _eo_)force_lazy_block(img$0)}}}
                               if(! switch$1)switch$0 = 1}
                             var _ee_=i$0 + 1 | 0;
                             if(_ed_ !== i$0){var i$0=_ee_;continue}
                             break}}
                         t713.timeEnd("draw");
                         return t713.log(image_count[1],large_image_count[1])};
                       perform_redraw(0);
                       var
                        t700=
                         handler
                          (function(param)
                            {var
                              t697=t818.documentElement,
                              w=t697.clientWidth,
                              h=t697.clientHeight,
                              _d4_=w !== t711.width?1:0,
                              _d5_=_d4_ || (h !== t711.height?1:0);
                                  ...
                                  (function(ev)
                                    {var x1=ev.clientX,y1=ev.clientY,_dR_=1 - started[1];
                                     if(_dR_)
                                      ...
                                      var _dT_=_dR_;
                                     if(_dT_)
                                      {started[1] = 1;var t29=t711.style;t29.cursor = "move"}
                                     if(started[1])
                                      {var
                                        z0=from_screen(t711,x0,y0),
                                        z1=from_screen(t711,x1,y1),
                                        match=tr[1],
                                        p=match[1],
                                               ...
                                               if(_dK_)
                                                {var x1=touch.clientX,y1=touch.clientY,_dL_=1 - started[1];
                                                 if(_dL_)
                                                  ...
                                                  var _dN_=_dL_;
                                                 if(_dN_)
                                                  {started[1] = 1;var t55=t711.style;t55.cursor = "move"}
                                                 var _dO_=started[1];
                                                 if(_dO_)
                                                  {t713.time("transform");
                                                   var
                                            ...
                                            {var _dx_=touch.identifier === id?1:0;
                                             if(_dx_)
                                              {removeEventListener(c1);
                                               iter$1(c2[1],removeEventListener);
                                               iter$1(c3[1],removeEventListener);
                                               if(started[1]){var t77=t711.style;t77.cursor = ""}
                                               tr[1] = tr$0[1];
                                               return 0}
                                             return _dx_},
                         ...
                         switch(switcher)
                          {case 0:
                           ...
                           default:
                            ...
                            schedule_redraw(0);
                            return t238}}
                       addEventListener(t818,keydown,handler(handle_key_event),t11);
                       var prev_buttons=[0,0];
                       function make_buttons(param)
                        {var _dq_=prev_buttons[1];
                         if(_dq_){var buttons=_dq_[1];removeChild(t818.body,buttons)}
                         var t722=createDiv(t818),t718=t722.style;
                         t718.position = "absolute";
                         var t721=t722.style;
                         t721.right = "0";
                         var t724=t722.style;
                         t724.bottom = "0";
                         var
                          t795=local_messages(all_messages),
                          t738=img_button(0,38,_c__),
                          t727=t738.style;
                         t727.position = "absolute";
                         var t730=t738.style;
                         t730.bottom = "2px";
                         var t733=t738.style;
                         t733.right = "0";
                         ...
                         var
                          t737=
                           handler
                            (function(param)
                              {show_information_page(t795,tree_i18n);return t238});
                         t738.onclick = t737;
                         var
                          t743=tooltip(opt_style(t795.info,"Information")),
                          t742=t743.style;
                         t742.right = "36px";
                         var t745=t743.style;
                         t745.bottom = "36px";
                         appendChild(t738,t743);
                         appendChild(t722,t738);
                         var t755=img_button(0,38,_c$_),t748=t755.style;
                         t748.position = "absolute";
                         var t751=t755.style;
                         t751.bottom = "2px";
                         var t754=t755.style;
                         t754.right = "48px";
                         ...
                         iter
                          (function(param)
                            {var
                              ...
                              name=param[1],
                              t763=createA(t818),
                              t758=caml_jsstring_of_string(name);
                             appendChild(t763,t818.createTextNode(t758));
                             t763.href = "#";
                             var
                              t762=
                               handler
                         ...
                         var
                          dd=createDd(t818),
                          t765=opt_style(t795.languages,"Languages");
                         appendChild(dd,t818.createTextNode(t765));
                         appendChild(dl,dd);
                         var dt=createDt(t818);
                         appendChild(dt,ul);
                         appendChild(dl,dt);
                         appendChild(t778,dl);
                         t778.className = "text on";
                         var t771=t778.style;
                         t771.position = "absolute";
                         var t774=t778.style;
                         t774.right = "0px";
                         var t777=t778.style;
                         t777.bottom = "46px";
                         var t780=t778.style;
                         t780.whiteSpace = "nowrap";
                         appendChild(t755,t778);
                         show_on_click(t755,t778);
                         appendChild(t722,t755);
                         var t794=img_button(0,38,_da_),t783=t794.style;
                         t783.position = "absolute";
                         var t786=t794.style;
                         t786.bottom = "2px";
                         var t789=t794.style;
                         t789.right = "96px";
                         ...
                         t794.onclick = t793;
                         var
                          t799=tooltip(opt_style(t795.recenter,"Recenter")),
                          t798=t799.style;
                         t798.right = "36px";
                         var t801=t799.style;
                         t801.bottom = "36px";
                         appendChild(t794,t799);
                         appendChild(t722,t794);
                         appendChild(t818.body,t722);
                         prev_buttons[1] = [0,t722];
                         return 0}
                       make_buttons(0);
                       var t804=createImg(t818),t803=icon(_db_);
                       t804.src = t803;
                       var t808=createA(t818);
                       t808.target = "_blank";
                       t808.href = "http://ocsigen.org/";
                       appendChild(t808,t804);
                       var t815=createDiv(t818),t811=t815.style;
                       t811.position = "absolute";
                       var t814=t815.style;
                       t814.left = "0";
                       var t817=t815.style;
                       t817.bottom = "0";
                       appendChild(t815,t808);
                       appendChild(t818.body,t815);
                       return return$0(0)})}),
       _dp_=underlying(p)[1];
      switch(_dp_[0])
