// Generated by js_of_ocaml 3.11.0+git-4ca2fc6
(function(Object)
   {typeof globalThis
    !==
    "object"
...
(function(globalThis)
   {"use strict";
    ...
    var
     ...
     git_version=caml_string_of_jsbytes("4ca2fc6"),
     languages=
      [0,
       [0,
    ...
    function draw(canvas,vertices,edges,nodes,boxes)
     {t713.time("draw");
      ...
      function _fF_(color){t208.fillStyle = color;return t208.fill()}
      iter$2(t279.backgroundColor,_fF_);
      function _fG_(color)
       {t208.lineWidth = 1.;t208.strokeStyle = color;return t208.stroke()}
      iter$2(t279.boundaryColor,_fG_);
      t208.lineWidth = 2.;
      t208.lineCap = "round";
      var t205=opt_style(t279.treeColor,tree_color);
      t208.strokeStyle = t205;
      var ry$2=transf[2],rx$2=transf[1],_fI_=edges.length - 1 - 1 | 0,_fH_=0;
      if(! (_fI_ < 0))
       {var i$0=_fH_;
        for(;;)
         {var
           ...
           {t208.lineWidth = w$3;
            ...
            if(Math.abs(d) < 0.05)
             ...
             {var
              ...
              t208.stroke()}}
          var _fW_=i$0 + 1 | 0;
          if(_fI_ !== i$0){var i$0=_fW_;continue}
          break}}
      var
       image_count=[0,0],
       large_image_count=[0,0],
       _fK_=nodes.length - 1 - 1 | 0,
       _fJ_=0;
      if(! (_fK_ < 0))
       {var i=_fJ_;
        for(;;)
            ...
            if(4204112 <= img[1])
             ...
             {var match$0=img[2],img$0=match$0[1];
                     ...
                     {var i=_fX_;
                      for(;;)
                       {var
                         ...
                         _fZ_=z[1],
                         sx=
                          Math.abs(caml_check_bound(vertices,j)[1 + j][1] - _fZ_)
                          /
                          w,
                         _f0_=z[2],
                         sy=
                          Math.abs(caml_check_bound(vertices,j)[1 + j][2] - _f0_)
                          /
                          h,
                         s$1=sy < sx?sx:sy,
              ...
              if(caml_obj_tag(img$0) !== 246)
               {var
                 _fP_=caml_obj_tag(img$0),
                 _fQ_=
                  250 === _fP_
                   ?img$0[1]
                   :246 === _fP_?force_lazy_block(img$0):img$0,
                 match$1=poll(_fQ_);
                if(match$1)
                 {var
                   img$1=match$1[1],
                  ...
                  if(_fS_)
                   {var
                    ...
                    image_count[1]++;
                    var _fT_=2. <= w$2?1:0,_fU_=_fT_?2. <= h$2?1:0:_fT_;
                    if(_fU_)large_image_count[1]++}}}
              else
               {var s$0=min_scale(l,1.,1.,1.);
                if(1. < s$0 * max(rx$2,ry$2))
                 {var _fV_=caml_obj_tag(img$0);
                  if(250 !== _fV_ && 246 === _fV_)force_lazy_block(img$0)}}}
    ...
    function tree_vertice_count(n)
     {var l=n[2],_fE_=1;
      return fold_left
              (function(s,n){return s + tree_vertice_count(n) | 0},_fE_,l)}
    ...
    function randomize_tree(n)
     {var ch=n[2],_fA_=ch.length - 1 - 1 | 0;
      if(! (_fA_ < 0))
       {var i=_fA_;
        for(;;)
         {var
           ...
           _fB_=caml_check_bound(ch,j)[1 + j];
          caml_check_bound(ch,i)[1 + i] = _fB_;
          caml_check_bound(ch,j)[1 + j] = v;
          var _fC_=i - 1 | 0;
          if(0 !== i){var i=_fC_;continue}
          break}}
              ...
              ?(need_redraw[1]
                ...
                caml_call1
                 (requestAnimationFrame,
                  caml_js_wrap_callback
                   (function(param)
                     {var _fz_=need_redraw[1];return _fz_?perform_redraw(0):_fz_})))
              :_fy_}
    ...
    function compute_text_nodes(node_names,nodes)
     {try
       ...
       {_fv_ = caml_wrap_exception(_fv_);
        ...
        var names=_fi_}
      try
       {var _fp_=find$0(names,_cK_),_fj_=_fp_}
      catch(_fu_)
       {_fu_ = caml_wrap_exception(_fu_);
        if(_fu_ !== Not_found)throw _fu_;
        var _fj_=_cJ_}
      t818.title = caml_jsstring_of_string(_fj_);
         ...
         {var match=caml_check_bound(nodes,i)[1 + i],_fm_=match[2],switch$0=0;
          if(typeof _fm_ !== "number" && 4204112 === _fm_[1])
           {var
             ...
             neigh=match[1];
            try
             {var _fo_=[0,compute_text_node(find$0(names,info))],canvas=_fo_}
            catch(_ft_)
    ...
    function close_button(over)
     {var
      ...
      t305.stroke();
      t305.restore();
      var _ev_=over?_cP_:_cQ_,t306=caml_jsstring_of_string(_ev_);
      t314.className = t306;
      var t310=t314.style;
     ...
     {function decoration(over)
       {var t318=createImg(t818),t317=icon(src);
        ...
        var
         ...
         t336=t338.style;
        t336.padding = t335;
        var _eu_=over?_cU_:_cW_,t337=caml_jsstring_of_string(cat(_cV_,_eu_));
        t338.className = t337;
                 ...
                 if(0 <= i[1])
                  {var
                   ...
                   var
                    ...
                    list=
                     function(title,lang)
                      {var ul=createUl(t818),empty=[0,1],_eo_=info[6];
                       iter$0
                        (function(param)
                          {var
                            refer=param[3],
                       ...
                       return _ep_},
                    _em_=language[1];
                   list(opt_style(t567.language,"In English"),_em_);
                       ...
                       function(param)
                        {need_redraw[1] = 0;
                         ...
                         var
                          ...
                          _d__=t689 !== t711.width?1:0,
                          _d$_=_d__ || (t691 !== t711.height?1:0);
                         if(_d$_){t711.width = t689;t711.height = t691}
                         var
                          _ea_=tr$0[1],
                          t$0=_ea_[2],
                          p=_ea_[1],
                         ...
                         return draw(t711,vertices$0,edges,nodes,boxes)};
                       perform_redraw(0);
                       var
                        t700=
                         handler
