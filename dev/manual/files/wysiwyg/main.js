...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _bZ_=caml_string_of_jsbytes("Dune__exe__Main.Break");
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_f7_ = caml_wrap_exception(_f7_);
              if(_f7_[1] !== Sys_error)throw _f7_;
              var _f6_=_f7_}
            var param$0=l;
            continue}
          return 0}}
     ...
     {var switch$0=0;
      if
       ...
       {var r=caml_create_bytes(len);
        ...
        var _f5_=r;
        switch$0 = 1}
      if(! switch$0)var _f5_=invalid_arg(_k_);
      return caml_string_of_bytes(_f5_)}
         ...
         {if(param)
           {var _f2_=param[1];
            if(param[2])
             {var
               tl=param[2],
               x=(caml_ml_string_length(_f2_) + seplen | 0) + acc | 0,
               acc$0=acc <= x?x:invalid_arg(_n_),
               acc=acc$0,
               param=tl;
              continue}
            var _f4_=caml_ml_string_length(_f2_) + acc | 0}
          else
           var _f4_=acc;
          var dst=caml_create_bytes(_f4_),pos=pos$1,param$0=l;
          for(;;)
           {if(param$0)
             {var _f3_=param$0[1];
              if(param$0[2])
               {var tl$0=param$0[2];
                caml_blit_string(_f3_,0,dst,pos,caml_ml_string_length(_f3_));
                caml_blit_string
                 (sep,0,dst,pos + caml_ml_string_length(_f3_) | 0,seplen);
                var
                 pos$0=(pos + caml_ml_string_length(_f3_) | 0) + seplen | 0,
                 pos=pos$0,
                 param$0=tl$0;
                continue}
              caml_blit_string(_f3_,0,dst,pos,caml_ml_string_length(_f3_))}
    ...
    function add(x,q)
     {var cell=[0,x,0],_f1_=q[3];
      return _f1_
              ?(q[1] = q[1] + 1 | 0,_f1_[2] = cell,q[3] = cell,0)
    ...
    function trans(ty1,match)
     {var switch$0=0;
      if(typeof ty1 === "number")
       ...
       switch(ty1[0])
        {case 0:
          var switch$1=0,_fG_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_fG_,rest2)];
          ...
          break;
         case 1:
          var switch$2=0,_fH_=ty1[1];
          if(typeof match !== "number")
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_fH_,rest2$0)];
          ...
          break;
         case 2:
          var switch$3=0,_fI_=ty1[1];
          if(typeof match === "number")
           switch$3 = 1;
          else
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_fI_,rest2$1)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 3:
          var switch$4=0,_fJ_=ty1[1];
          if(typeof match === "number")
           switch$4 = 1;
          else
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_fJ_,rest2$2)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 4:
          var switch$5=0,_fK_=ty1[1];
          if(typeof match === "number")
           switch$5 = 1;
          else
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_fK_,rest2$3)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 5:
          var switch$6=0,_fL_=ty1[1];
          if(typeof match === "number")
           switch$6 = 1;
          else
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_fL_,rest2$4)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 6:
          var switch$7=0,_fM_=ty1[1];
          if(typeof match === "number")
           switch$7 = 1;
          else
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_fM_,rest2$5)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 7:
          var switch$8=0,_fN_=ty1[1];
          if(typeof match === "number")
           switch$8 = 1;
          else
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_fN_,rest2$6)];
             case 8:switch$0 = 5;break;
             case 9:switch$0 = 6;break;
             case 10:break;
             case 11:switch$0 = 1;break;
          ...
          break;
         case 8:
          var switch$9=0,_fO_=ty1[2],_fP_=ty1[1];
          if(typeof match === "number")
           switch$9 = 1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_fQ_=trans(_fO_,rest2$7);
              return [8,trans(_fP_,ty2),_fQ_];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
          ...
          break;
         case 9:
          var switch$10=0,_fR_=ty1[3],_fS_=ty1[2],_fT_=ty1[1];
          if(typeof match === "number")
           switch$10 = 1;
          else
           switch(match[0])
            {case 8:switch$0 = 5;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_fS_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_fT_,ty22,trans(_fR_,rest2$8)];
             case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_fU_,rest2$9)]}
          throw [0,Assert_failure,_aa_];
         case 11:
          var switch$11=0,_fV_=ty1[1];
          if(typeof match === "number")
           switch$11 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:var rest2$10=match[1];return [11,trans(_fV_,rest2$10)];
             default:switch$11 = 1}
          if(switch$11)throw [0,Assert_failure,_ab_];
          break;
         case 12:
          var switch$12=0,_fW_=ty1[1];
          if(typeof match === "number")
           switch$12 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:var rest2$11=match[1];return [12,trans(_fW_,rest2$11)];
             default:switch$12 = 1}
          if(switch$12)throw [0,Assert_failure,_ac_];
          break;
         case 13:
          var switch$13=0,_fX_=ty1[1];
          if(typeof match === "number")
           switch$13 = 1;
          else
           switch(match[0])
            {case 10:break;
             case 11:switch$0 = 1;break;
             case 12:switch$0 = 2;break;
             case 13:var rest2$12=match[1];return [13,trans(_fX_,rest2$12)];
             default:switch$13 = 1}
          if(switch$13)throw [0,Assert_failure,_ad_];
          break;
         default:
          var switch$14=0,_fY_=ty1[1];
          if(typeof match === "number")
           switch$14 = 1;
          else
           switch(match[0])
            {case 10:break;
             ...
             case 12:switch$0 = 2;break;
             case 13:switch$0 = 3;break;
             case 14:var rest2$13=match[1];return [14,trans(_fY_,rest2$13)];
             default:switch$14 = 1}
        ...
        {case 0:
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _fA_=function(param){caml_call1(de$12,0);return 0},
           _fB_=function(param){caml_call1(ed$12,0);return 0},
           _fC_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _fD_=function(param){caml_call1(de$13,0);return 0},
           _fE_=function(param){caml_call1(ed$13,0);return 0},
           _fF_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       {if(prec)
         {var _fh_=match[2];
          if(typeof _fh_ !== "number" && 2 === _fh_[0])
           {var rest=_fh_[1],pad$0=match[1];return [0,pad$0,1,rest]}
          throw Type_mismatch}
        ...
        {case 0:
         ...
         case 2:
          var
           ...
           _e0_=match$1[2],
           _eZ_=match$1[1];
          if(typeof _e0_ !== "number" && 1 === _e0_[0])
           {var
             fmtty_rest$1=_e0_[1],
             match$2=type_format_gen(fmt_rest$1,fmtty_rest$1),
             fmtty$2=match$2[2],
             fmt$2=match$2[1];
            return [0,[2,_eZ_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
         ...
         case 4:
          ...
          if(typeof _e4_ !== "number" && 2 === _e4_[0])
           {var
             ...
             fmtty$4=match$6[2],
             fmt$4=match$6[1];
            return [0,[4,iconv,_e3_,prec$0,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
          ...
          if(typeof _e6_ !== "number" && 3 === _e6_[0])
           {var
             ...
             fmtty$5=match$8[2],
             fmt$5=match$8[1];
            return [0,[5,iconv$0,_e5_,prec$2,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           _e8_=match$9[3],
           _e7_=match$9[1];
          if(typeof _e8_ !== "number" && 4 === _e8_[0])
           {var
             fmtty_rest$5=_e8_[1],
             prec$4=match$9[2],
             ...
             fmtty$6=match$10[2],
             fmt$6=match$10[1];
            return [0,[6,iconv$1,_e7_,prec$4,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           _e__=match$11[3],
           _e9_=match$11[1];
          if(typeof _e__ !== "number" && 5 === _e__[0])
           {var
             fmtty_rest$6=_e__[1],
             prec$6=match$11[2],
             ...
             fmtty$7=match$12[2],
             fmt$7=match$12[1];
            return [0,[7,iconv$2,_e9_,prec$6,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
          ...
          if(typeof _fa_ !== "number" && 6 === _fa_[0])
           {var
             ...
             fmtty$8=match$14[2],
             fmt$8=match$14[1];
            return [0,[8,fconv,_e$_,prec$8,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           ...
           _fc_=match$15[2],
           _fb_=match$15[1];
          if(typeof _fc_ !== "number" && 7 === _fc_[0])
           {var
             fmtty_rest$8=_fc_[1],
             match$16=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$16[2],
             fmt$9=match$16[1];
            return [0,[9,_fb_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _fd_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_fd_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _fe_=type_ignored_format_substituti(sub_fmtty$3,rest,fmtty),
               match$35=_fe_[2],
               fmtty$22=match$35[2],
               fmt$22=match$35[1],
               sub_fmtty$4=_fe_[1];
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _eY_=2 === padty$0?48:32,res=make(width$0,_eY_);
      switch(padty$0)
      ...
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           ...
           switch$0=0;
          if(59 < _eW_ >>> 0)
           {if(33 < (_eW_ - 61 | 0) >>> 0)switch$0 = 1}
          else
           if(2 === _eW_)switch$0 = 1;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _eP_=caml_ml_bytes_length(s$0) - 1 | 0,
           _eO_=0;
          if(! (_eP_ < 0))
           {var i$0=_eO_;
            for(;;)
             {var match=caml_bytes_unsafe_get(s$0,i$0),switch$1=0;
              if(32 <= match)
               {var _eT_=match - 34 | 0,switch$2=0;
                if(58 < _eT_ >>> 0)
                 {if(93 <= _eT_)switch$2 = 1}
                else
                 if(56 < (_eT_ - 1 | 0) >>> 0){switch$1 = 1;switch$2 = 1}
                if(! switch$2){var _eU_=1;switch$1 = 2}}
              else
               if(11 <= match)
              ...
              switch(switch$1)
               {case 0:var _eU_=4;break;case 1:var _eU_=2;break}
              n[1] = n[1] + _eU_ | 0;
              var _eV_=i$0 + 1 | 0;
              if(_eP_ !== i$0){var i$0=_eV_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _eR_=caml_ml_bytes_length(s$0) - 1 | 0,_eQ_=0;
            if(! (_eR_ < 0))
             {var i=_eQ_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i),switch$3=0;
                ...
                break}}
            var _eX_=s}
          var str$0=caml_string_of_bytes(_eX_)}
    ...
    function transform_int_alt(iconv,s)
     {if(13 <= iconv)
       {var n=[0,0],_eJ_=caml_ml_string_length(s) - 1 | 0,_eI_=0;
        if(! (_eJ_ < 0))
         {var i$0=_eI_;
          for(;;)
           {var match=caml_string_unsafe_get(s,i$0),switcher$0=match - 48 | 0;
            ...
            var _eN_=i$0 + 1 | 0;
            if(_eJ_ !== i$0){var i$0=_eN_;continue}
            break}}
        var
         digits=n[1],
         buf=
         ...
         _eL_=caml_ml_string_length(s) - 1 | 0,
         _eK_=0;
        if(! (_eL_ < 0))
         {var i=_eK_;
          for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 1:var _eH_=_ah_;break;
        case 2:var _eH_=_ai_;break;
        case 4:var _eH_=_ak_;break;
        case 5:var _eH_=_al_;break;
        case 6:var _eH_=_am_;break;
        case 7:var _eH_=_an_;break;
        case 8:var _eH_=_ao_;break;
        case 9:var _eH_=_ap_;break;
        case 10:var _eH_=_aq_;break;
        case 11:var _eH_=_ar_;break;
        case 0:
        case 13:var _eH_=_ag_;break;
        case 3:
        case 14:var _eH_=_aj_;break;
        default:var _eH_=_as_}
    ...
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 1:var _eF_=_aU_;break;
        case 2:var _eF_=_aV_;break;
        case 4:var _eF_=_aX_;break;
        case 5:var _eF_=_aY_;break;
        case 6:var _eF_=_aZ_;break;
        case 7:var _eF_=_a0_;break;
        case 8:var _eF_=_a1_;break;
        case 9:var _eF_=_a2_;break;
        case 10:var _eF_=_a3_;break;
        case 11:var _eF_=_a4_;break;
        case 0:
        case 13:var _eF_=_aT_;break;
        case 3:
        case 14:var _eF_=_aW_;break;
        default:var _eF_=_a5_}
    ...
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 1:var _eE_=_au_;break;
        ...
        case 7:var _eE_=_aA_;break;
        case 8:var _eE_=_aB_;break;
        case 9:var _eE_=_aC_;break;
        case 10:var _eE_=_aD_;break;
        case 11:var _eE_=_aE_;break;
        case 0:
        case 13:var _eE_=_at_;break;
        case 3:
        case 14:var _eE_=_aw_;break;
        default:var _eE_=_aF_}
      return transform_int_alt(iconv,caml_int64_format(_eE_,n))}
         ...
         for(;;)
          {if(i$0 === len)
            ...
            {var
              ...
              switch$0=0;
             if(23 < _eB_ >>> 0)
              {if(55 === _eB_)switch$0 = 1}
             else
              if(21 < (_eB_ - 1 | 0) >>> 0)switch$0 = 1;
             if(! switch$0){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
             var _eC_=1}
           var _eD_=_eC_?str:symbol(str,_a6_);
           return caml_special_val(_eD_)}
        case 6:return hex(0);
        case 7:
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _es_=pad$5[2],_et_=pad$5[1];
               if(typeof prec$3 === "number")
                return prec$3
                        ?function(p,x)
                          {var str=fix_padding(_et_,_es_,convert_float(fconv,p,x));
                           return make_printf(k$0,[4,acc$0,str],rest$7)}
                        :function(x)
                          {var
                            str=convert_float(fconv,default_float_precision(fconv),x),
                            str$0=fix_padding(_et_,_es_,str);
                           return make_printf(k$0,[4,acc$0,str$0],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_et_,_es_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,[4,acc$0,str],rest$7)}}
             var _eu_=pad$5[1];
             if(typeof prec$3 === "number")
              return prec$3
                      ?function(w,p,x)
                        {var str=fix_padding(_eu_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,[4,acc$0,str],rest$7)}
                      :function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision(fconv),x),
                          str$0=fix_padding(_eu_,w,str);
                         return make_printf(k$0,[4,acc$0,str$0],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_eu_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _ev_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _ev_[2] === "number")
              {var fmt=_ev_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,acc$0,rest$19,arity,_er_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,acc$0,rest$19,arity,_er_])}}
    ...
    function make_invalid_arg(counter,k,acc,fmt)
     {var _eo_=[8,acc,_be_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_eo_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,_eo_,fmt])}
    function make_custom$0(counter,k,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,_en_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,_en_,rest])}
           ...
           return match
                   ?function(p,x)
                     {var
                       str=
                        fix_padding
                         (_el_,_ek_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,[4,acc,str],fmt)}
                   :function(x)
                     {var str=fix_padding(_el_,_ek_,caml_call2(trans,iconv,x));
                      return make_printf(k,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_el_,_ek_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,[4,acc,str],fmt)}}
        var _em_=pad[1];
        if(typeof match === "number")
         return match
                 ?function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_em_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,[4,acc,str],fmt)}
                 :function(w,x)
                   {var str=fix_padding(_em_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_em_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,[4,acc,str],fmt)}}}
           ...
           {var
            ...
            if(0 === slot[0])
             var
              ...
              match=
               [0,
                caml_call7(sprintf(_bC_),_d5_,_d4_,_d3_,_d2_,_d1_,_d0_,_dZ_)];
            else
             if(slot[1])
              var match=0;
             else
    ...
    function sleep(d)
     {var t=new_pending(1),d$0=d * 1000.;
      ...
      function f(param)
       {var _dx_=id[1];
        if(_dx_){var x=_dx_[1];id[1] = 0;return t2.clearTimeout(x)}
        return 0}
      ...
      function add_str(opt,s)
       {if(opt)var sth=opt[1],surr=sth;else var surr=_b0_;
        return is_visible_text(s)
                ...
                :0}
      var t1=body.childNodes,_dk_=t1.length - 1 | 0,_dj_=0;
      if(! (_dk_ < 0))
       {var i=_dj_;
        for(;;)
         {var
              ...
              if(0 <= switch$0)
               ...
               {if(! caml_string_notequal(hh,_cb_))
                ...
                if(! caml_string_notequal(hh,_cc_))
                 {var
                   t4=get(node,function(param){throw [0,Assert_failure,_ci_]}),
                   _do_=
                    function(s)
                     {var _dq_=caml_string_of_jsstring;
                      function _dr_(param){throw [0,Assert_failure,_cj_]}
                      var
                       url=symbol$0(get(t4.getAttribute("href"),_dr_),_dq_),
                  ...
                  return case$0(t4.getAttribute("wysitype"),_dp_,_do_)}
    ...
    function onload(param)
     {function _c9_(param){throw [0,Assert_failure,_cv_]}
      var
       body=get(t87.getElementById("wiki_demo"),_c9_),
       iframe=unsafeCreateElement(t87,_bL_);
      ...
      function _c__(iDoc)
       {iDoc.open();
        ...
        iDoc.close();
        iDoc.designMode = "On";
        var t49=iframe.contentWindow;
        appendChild(body,createBr(t87));
        function createButton(opt,_dh_,title,action)
         {if(opt)var sth=opt[1],show=sth;else var show=t45;
          if(_dh_)var sth$0=_dh_[1],value=sth$0;else var value=0;
          var type=[0,"submit"],but=unsafeCreateElementEx(type,0,t87,_bI_);
           ...
           (function(param)
             {t49.focus();
              if(value)
               ...
               var _di_=no_handler;
              var t63=caml_jsstring_of_string(action);
              iDoc.execCommand(t63,show,_di_);
              return true$0});
        ...
        function prompt(query,default$0)
         {var _df_=caml_string_of_jsstring;
          ...
          var
           t61=caml_jsstring_of_string(default$0),
           t60=caml_jsstring_of_string(query);
          return symbol$0(get(t49.prompt(t60,t61),_dg_),_df_)}
        var
         _c$_=
          handler
           (function(param)
             {var
               ...
               t56=caml_jsstring_of_string(link$0);
              t49.alert(t56);
              var t54=caml_jsstring_of_string(link$0);
              iDoc.execCommand("inserthtml",t45,t54);
              return true$0});
          ...
          handler
           (function(param)
             {var
               ...
               t48=caml_jsstring_of_string(link$0);
              t49.alert(t48);
              var t46=caml_jsstring_of_string(link$0);
              iDoc.execCommand("inserthtml",t45,t46);
              return true$0});
        createButton(0,0,_c7_,_c6_).onclick = _da_;
        appendChild(body,createBr(t87));
        var preview=createTextarea(0,0,t87);
        ...
        var wikiFrame=createTextarea(0,0,t87);
